...
import { Clock, Loader2, Save, Store as StoreIcon, Trash2 } from 'lucide-react';
...
function StoreSettingsContent() {
  ...
  const [activeTab, setActiveTab] = useState<'hours' | 'recycle-bin'>('hours');

  useEffect(() => {
    if (searchParams.get('tab') === 'recycle-bin') {
