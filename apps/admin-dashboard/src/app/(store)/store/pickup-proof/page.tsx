      ...
      <div className="space-y-5">
        <header className="flex flex-wrap items-center justify-between gap-4 rounded-[2rem] bg-slate-950 p-6 text-white">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-semibold">Pickup Proof</h1>
        ...
        {!loading && jobs.length === 0 && (
          <div className="rounded-xl border border-dashed bg-white p-12 text-center">
            ...
            <p className="mt-3 font-semibold">No Riders awaiting pickup proof</p>
          </div>
        )}
          ...
          >
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <button
                ...
                className="rounded-xl bg-indigo-700 px-4 py-2.5 text-sm font-semibold text-white"
              >
            ...
            {challenges[job.id] && (
              <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-4">
                ...
                <p className="mt-2 break-all font-mono text-xl font-semibold text-amber-950">
