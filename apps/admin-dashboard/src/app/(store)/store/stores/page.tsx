    ...
    <DashboardLayout allowedRole="STORE_OWNER">
      <div className="mb-6 flex items-center justify-between">
        <div>
          ...
          <h1 className="mt-2 text-3xl font-semibold tracking-tight">My Stores</h1>
        </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          {stores.map((store) => (
            <div key={store.id} className="enterprise-card overflow-hidden p-0 transition ">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <span className={`mt-1 inline-flex rounded-full px-2 py-0.5 text-[10px] font-semibold ${store.isActive ? 'bg-emerald-400/20 text-emerald-300' : 'bg-white/10 text-slate-400'}`}>
