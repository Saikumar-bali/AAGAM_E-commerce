  ...
  return (
    <DashboardLayout allowedRole="CUSTOMER">
      <div className="mx-auto max-w-2xl space-y-5">
        ...
        <header className="rounded-[2rem] border border-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-violet-950 p-6 text-white ">
          <div className="flex items-start gap-4">
            <div className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-white/10 ring-1 ring-white/15">
              <ShieldCheck className="h-6 w-6 text-violet-200" />
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.22em] text-violet-300">Secure handoff</p>
              <h1 className="mt-2 text-3xl font-semibold tracking-tight">Delivery verification</h1>
