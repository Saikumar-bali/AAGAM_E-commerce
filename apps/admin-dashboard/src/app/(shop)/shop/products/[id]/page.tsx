  ...
  return (
    <DashboardLayout allowedRole="CUSTOMER">
      <div className="mx-auto max-w-6xl space-y-6 pb-32 md:pb-10">
        ...
        {loading ? <div className="rounded-3xl border border-slate-100 bg-white p-6 animate-pulse"><div className="grid gap-6 lg:grid-cols-2"><div className="aspect-square rounded-2xl bg-slate-100" /><div className="space-y-4"><div className="h-4 w-24 rounded bg-slate-100" /><div className="h-8 w-3/4 rounded bg-slate-100" /><div className="h-4 w-full rounded bg-slate-100" /><div className="h-10 w-32 rounded bg-slate-100" /></div></div></div> : error ? <div className="rounded-3xl border border-red-100 bg-red-50 p-8 text-center"><p className="text-sm font-bold text-red-700">{error}</p><button onClick={() => router.push('/shop')} className="mt-4 rounded-xl bg-red-600 px-4 py-2 text-sm font-black text-white">Back to shop</button></div> : !product ? <div className="rounded-3xl border border-slate-100 bg-white p-8 text-center"><p className="text-sm text-slate-500">Product not found.</p></div> : <>
          <div className="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm">
            <div className="grid gap-0 lg:grid-cols-2">
              ...
              <div className="flex flex-col p-6 lg:p-8">
                ...
                <h1 className="mt-2 text-2xl font-black tracking-tight text-slate-950 lg:text-3xl">{product.name}</h1><p className="mt-3 text-sm font-semibold leading-6 text-slate-500">{product.description || 'Freshly stocked and ready for a fast doorstep delivery.'}</p>
