      ...
      <div className="mx-auto max-w-6xl pb-10">
        <div className="mb-5 flex items-center gap-3">
          <button
            ...
            className="grid h-9 w-9 place-items-center rounded-lg border border-slate-200 bg-white text-slate-600 transition-colors hover:bg-slate-50"
          >
            <ArrowLeft className="h-4 w-4" />
          </button>
          <div>
            <p className="enterprise-kicker">Deals</p>
          ...
          <div className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  {campaigns.map((campaign) => (
                    <button
                      ...
                      className="group relative min-h-52 overflow-hidden rounded-xl p-6 text-left  transition-transform enabled:"
                      style={{
                    ...
                    >
                      ...
                      <div className="relative">
                        {campaign.badgeText && (
                          <span className="rounded-full bg-white/20 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider">
                            {campaign.badgeText}
                          </span>
                        )}
                        ...
                        {campaign.targetUrl && (
                          <span
                            className="mt-5 inline-flex items-center gap-1.5 rounded-xl px-3 py-2 text-xs font-semibold text-slate-950"
            ...
            <section>
              <div className="mb-3 flex items-center gap-2">
                ...
                <h2 className="text-sm font-semibold uppercase tracking-wider text-slate-950">
                  Available coupons
                </h2>
              </div>
              {coupons.length === 0 ? (
                          ...
                          <div className="flex shrink-0 items-center gap-2">
                            {coupon.code && (
                              ...
                              >
                                ...
                                <span className="inline-flex items-center gap-1.5 font-mono text-sm font-semibold text-slate-950">
                                  {coupon.code}
                                  {copied === coupon.id ? (
                            ...
                            <button
                              ...
                              className="rounded-xl bg-slate-950 px-4 py-3 text-xs font-semibold text-white hover:bg-teal-800 disabled:cursor-not-allowed disabled:opacity-40"
                            >
                              {coupon.applicationMode === "AUTO"
                                ? "Shop now"
                                : "Use offer"}
