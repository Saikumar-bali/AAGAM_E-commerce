  ...
  return (
    <>
      ...
      <Link
        ...
        className="fixed bottom-24 right-4 z-[70] inline-flex min-h-12 items-center gap-2 rounded-xl border border-white/70 bg-slate-950 px-4 py-3 text-sm font-semibold text-white  shadow-slate-950/25 transition  hover:bg-emerald-700 lg:bottom-6 lg:right-6"
      >
