...
export default function AdminProductsPage() {
  ...
  const saveProduct = async (event: React.FormEvent) => {
    ...
    try {
      ...
      if (!payload.name || !payload.categoryId || !Number.isFinite(payload.price) || payload.price <= 0 || !Number.isFinite(payload.mrp) || payload.mrp < payload.price) throw new Error('Enter a valid selling price and an MRP greater than or equal to it.');
