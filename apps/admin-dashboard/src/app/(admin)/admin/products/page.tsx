...
const emptyForm = (): ProductForm => ({ name: '', description: '', price: '', categoryId: '', image: '', details: emptyDetails() });
...
export default function AdminProductsPage() {
  ...
  const openEditProduct = (product: Product) => {
    ...
    setForm({ name: product.name, description: product.description || '', price: String(product.price), categoryId: product.categoryId, image: product.image || '', details: nextDetails });
    setError('');
  ...
  const saveProduct = async (event: React.FormEvent) => {
    ...
    setError('');
    try {
      const payload = { name: form.name.trim(), description: form.description.trim() || null, price: Number(form.price), categoryId: form.categoryId, image: form.image.trim() || null, details: form.details };
