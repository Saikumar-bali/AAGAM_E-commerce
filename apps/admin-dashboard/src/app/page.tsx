    ...
    <main className="min-h-screen bg-[#f7f8f7] text-[#16231f]">
      ...
      <footer className="bg-[#063b3a] text-white">
        <div className="mx-auto grid max-w-[1448px] gap-7 px-6 py-6 md:grid-cols-2 lg:grid-cols-[1.25fr_.8fr_.8fr_1.2fr_1.1fr] lg:px-10">
          ...
          <div><h3 className="text-[11px] font-black">Shop</h3><div className="mt-2 grid gap-1 text-[10px] font-semibold text-white/70"><a href="#categories" onClick={(e) => { e.preventDefault(); setQuery(''); requestAnimationFrame(() => document.getElementById('categories')?.scrollIntoView({ behavior: 'smooth' })); }}>All Categories</a><a href="#offers" onClick={(e) => { e.preventDefault(); setQuery('Fruits'); showCategory('Fruits'); }}>Fruits & Vegetables</a><a href="#offers" onClick={(e) => { e.preventDefault(); setQuery('Dairy'); showCategory('Dairy'); }}>Dairy & Eggs</a><a href="#offers" onClick={(e) => { e.preventDefault(); setQuery('Deals'); showCategory('Deals'); }}>Deals</a><a href="#offers" onClick={(e) => { e.preventDefault(); setQuery('Beverages'); showCategory('Beverages'); }}>Beverages</a></div></div>
