      ...
      <div className="relative mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="enterprise-panel px-4 py-8 sm:px-10">
          <form className="space-y-6" onSubmit={handleSignup}>
            ...
            <div className="rounded-2xl border border-teal-100 bg-teal-50/80 p-4 text-sm font-semibold text-teal-900">Public signup creates customer accounts only. Store and rider access requires admin approval.</div>
          ...
          <div className="mt-6 grid gap-3 sm:grid-cols-2"><Link href="/partner" className="rounded-2xl border border-slate-200 bg-white p-4 text-sm font-black text-slate-700 transition hover:border-teal-300"><Store className="mb-2 h-5 w-5 text-teal-700" /> Store access</Link><Link href="/partner" className="rounded-2xl border border-slate-200 bg-white p-4 text-sm font-black text-slate-700 transition hover:border-teal-300"><Bike className="mb-2 h-5 w-5 text-teal-700" /> Rider access</Link></div>
        </div>
      </div>
    </div>
  );
