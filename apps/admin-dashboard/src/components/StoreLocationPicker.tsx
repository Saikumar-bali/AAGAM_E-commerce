    ...
    >
      ...
      <div className="pointer-events-none absolute left-1/2 top-1/2 z-20 -translate-x-1/2 -translate-y-full">
        <div className="relative">
          <div className="h-10 w-10 rotate-45 rounded-full rounded-br-sm border-4 border-white bg-red-500  shadow-slate-900/30" />
          <div className="absolute left-1/2 top-1/2 h-3 w-3 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white" />
        </div>
        <div className="mx-auto mt-1 h-2 w-8 rounded-full bg-slate-900/25 blur-[1px]" />
      </div>
      <div className="pointer-events-none absolute bottom-2 right-2 z-20 rounded bg-white/90 px-2 py-1 text-[10px] font-semibold text-slate-600 ">
        © OpenStreetMap
      </div>
    </div>
  );
  ...
  return (
    <div className={compact ? 'space-y-2' : 'space-y-3'}>
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto flex overflow-hidden rounded-xl border border-gray-200 bg-white text-xs font-semibold text-gray-700">
      ...
      <div className="relative">
        ...
        {searchResults.length > 0 && (
          <div className="absolute left-0 right-0 top-full z-50 mt-1 max-h-48 overflow-y-auto rounded-xl border border-gray-100 bg-white ">
            {searchResults.map((result, i) => (
              ...
              >
                <span className="text-[10px] font-semibold uppercase text-emerald-700">{result.type}</span>
