...
test.describe('Phase 1.1: event-level notification preferences', () => {
  test('all role settings pages render their relevant events', async ({ browser }) => {
    const cases: Array<{
      ...
      { role: 'ADMIN', route: '/admin/notifications/settings', heading: /Operations notification preferences/i, event: 'New order placed', screenshot: '06-admin-settings.png' },
      { role: 'CUSTOMER', route: '/shop/notifications/settings', heading: /Your notification preferences/i, event: 'Store accepted order', screenshot: '07-customer-settings.png' },
      { role: 'STORE_OWNER', route: '/store/notifications/settings', heading: /Store notification preferences/i, event: 'New order placed', screenshot: '08-store-settings.png' },
      { role: 'RIDER', route: '/rider/notifications/settings', heading: /Rider notification preferences/i, event: 'Delivery offer', screenshot: '09-rider-settings.png' },
    ];
