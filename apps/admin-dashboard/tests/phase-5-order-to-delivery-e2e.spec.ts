...
test.describe('Phase 5 E2E: Order-to-Delivery Workflow', () => {

  test('01 — Store owner sees orders page', async ({ page }) => {
  ...
  test('02 — Admin sees orders page', async ({ page }) => {
  ...
  test('03 — Rider dashboard page', async ({ page }) => {
  ...
  test('04 — Customer live tracking page renders', async ({ page }) => {
    ...
    const firstOrder = page.locator('[href*="/shop/orders/"]').first();
  ...
  test('05 — Admin live tracking map renders', async ({ page }) => {
    await loginViaForm(page, 'admin@aagam.com', 'Admin@123');
    await waitForDashboard(page, '/admin');
