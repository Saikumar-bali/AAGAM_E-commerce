...
export class DeliveryOperationsController {
  ...
  recordFailure(
    ...
    return this.operations.recordFailure(deliveryJobId, req.user, body, idempotencyKey);
  }
  ...
  confirmReturn(
    ...
    return this.operations.confirmReturn(deliveryJobId, req.user, idempotencyKey);
  }
  ...
  inspectReturn(
    ...
    return this.operations.inspectReturn(deliveryJobId, req.user, body, idempotencyKey);
  }
  ...
  collectCod(
    ...
    return this.operations.collectCod(deliveryJobId, req.user, body, idempotencyKey);
  }
  ...
  settleCod(
    ...
    return this.operations.settleCod(deliveryJobId, req.user, body, idempotencyKey);
  }
  ...
  complete(
    ...
    return this.operations.completeDelivery(deliveryJobId, req.user, body, idempotencyKey);
  }
}
