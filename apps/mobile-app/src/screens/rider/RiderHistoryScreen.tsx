        ...
        <View key={order.id} style={styles.card}>
          ...
          <View style={styles.metricRow}>
            <View style={styles.metricPill}>
              <Route size={14} color="#0F766E" />
              <Text style={styles.metricText}>{order.trackingSummary?.distanceKm ?? 0} km</Text>
            </View>
            <View style={styles.metricPill}>
              <Clock3 size={14} color="#1D4ED8" />
              <Text style={styles.metricText}>{formatDuration(order.trackingSummary?.durationMinutes)}</Text>
            </View>
          </View>
