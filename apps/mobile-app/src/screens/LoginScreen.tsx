...
export const LoginScreen = () => {
  ...
  const explainPhoneLogin = () => {
    Alert.alert('Phone login not enabled yet', 'Firebase Phone Number Verification can verify numbers without SMS on supported carrier/device flows, but the backend must verify the Firebase token before Aagam can issue a login session. Use email or Google for local testing now.');
  };
    ...
    <View style={styles.container}>
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={styles.content}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Customer shopping, tracking, support, and alerts</Text>
        </View>
        ...
        <View style={styles.glassCard}>
          ...
          <TouchableOpacity style={styles.phoneBtn} onPress={explainPhoneLogin}>
            ...
            <View style={{ flex: 1 }}><Text style={styles.phoneTitle}>Phone login path</Text><Text style={styles.phoneText}>Needs Firebase PNV backend verification before enabling.</Text></View>
          </TouchableOpacity>
