...
export const CheckoutScreen = () => {
  ...
  const placeOrderMutation = useMutation({
    mutationFn: async () =>
      apiClient.post('/checkout/place-order', {
        items: itemsPayload,
        addressId: selectedAddressId,
        paymentMethod,
      }),
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
        ...
        return (
          ...
          >
            <Text style={styles.addressLabel}>
              {address.label || 'Address'} {active ? '• Selected' : ''}
            </Text>
      ...
      <TouchableOpacity
        style={[
          ...
          (!selectedAddressId || placeOrderMutation.isPending || quote?.serviceable === false) && styles.placeOrderButtonDisabled,
        ]}
