  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        ...
        ListEmptyComponent={<View style={styles.empty}><Text style={styles.emptyTitle}>No notifications yet</Text><Text style={styles.emptyText}>Order updates and support alerts will appear here.</Text></View>}
        renderItem={({ item }) => (
          <View style={[styles.card, item.readAt && styles.cardRead]}>
            ...
            {!item.readAt ? (
              <TouchableOpacity style={styles.readButton} onPress={() => markRead.mutate(item.sourceHistoryId)}>
