...
const styles = StyleSheet.create({
  ...
  flex: { flex: 1 },
  summary: { minHeight: 64, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#B7E4D7', padding: 9, flexDirection: 'row', alignItems: 'center', gap: 8 },
  phaseIcon: { width: 38, height: 38, borderRadius: 12, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' },
  eyebrow: { color: '#0F766E', fontSize: 8, fontWeight: '600', letterSpacing: 1 },
  title: { color: '#0F172A', fontSize: 14, fontWeight: '600', marginTop: 2 },
  destination: { color: '#64748B', fontSize: 10, marginTop: 2 },
  metric: { minWidth: 34, alignItems: 'center' },
  metricValue: { color: '#0F172A', fontSize: 14, fontWeight: '600' },
  metricLabel: { color: '#64748B', fontSize: 7, fontWeight: '600', marginTop: 1 },
  warning: { marginTop: 8, borderRadius: 14, backgroundColor: '#FFF7ED', borderWidth: 1, borderColor: '#FED7AA', padding: 10, flexDirection: 'row', alignItems: 'center', gap: 8 },
  warningTitle: { color: '#92400E', fontSize: 11, fontWeight: '600' },
  ...
  liveText: { color: '#047857', fontSize: 10, fontWeight: '600', flex: 1 },
  liveDetail: { color: '#64748B', fontSize: 9, fontWeight: '500' },
  mapButton: { height: 38, borderRadius: 11, backgroundColor: '#ECFDF5', paddingHorizontal: 8, alignItems: 'center', justifyContent: 'center' }, mapButtonText: { color: '#0F766E', fontSize: 8, fontWeight: '600', marginTop: 1 }, navigateButton: { width: 38, height: 38, borderRadius: 11, backgroundColor: '#008C68', alignItems: 'center', justifyContent: 'center' }, disabled: { opacity: 0.45 },
  mapModal: { flex: 1, backgroundColor: '#F4F7FB', paddingHorizontal: 12 }, mapModalHeader: { minHeight: 58, flexDirection: 'row', alignItems: 'center', gap: 10 }, mapModalEyebrow: { color: '#0F766E', fontSize: 9, fontWeight: '600', letterSpacing: 1 }, mapModalTitle: { color: '#0F172A', fontSize: 17, fontWeight: '600', marginTop: 2 }, closeButton: { width: 42, height: 42, borderRadius: 13, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' },
});
