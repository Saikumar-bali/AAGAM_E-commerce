...
const styles = StyleSheet.create({
  floating: { position: 'absolute', right: 14, bottom: 86, zIndex: 40, minHeight: 46, borderRadius: 23, backgroundColor: '#0F766E', paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', gap: 8, shadowColor: '#000', shadowOpacity: 0.18, shadowRadius: 8, elevation: 8 },
  floatingText: { color: '#FFFFFF', fontSize: 11, fontWeight: '600' },
  ...
  eyebrow: { marginTop: 12, color: '#0F766E', fontSize: 9, fontWeight: '600', letterSpacing: 1 },
  title: { marginTop: 4, color: '#0F172A', fontSize: 22, fontWeight: '600' },
  subtitle: { marginTop: 8, color: '#64748B', fontSize: 12, lineHeight: 18, fontWeight: '600' },
  ...
  cameraTitle: { marginTop: 8, color: '#0F766E', fontSize: 14, fontWeight: '600' },
  ...
  retake: { minHeight: 44, backgroundColor: '#F0FDFA', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  retakeText: { color: '#0F766E', fontSize: 12, fontWeight: '600' },
  ...
  confirmText: { flex: 1, color: '#334155', fontSize: 11, lineHeight: 17, fontWeight: '500' },
  ...
  submitText: { color: '#FFFFFF', fontSize: 13, fontWeight: '600' },
