...
const styles = StyleSheet.create({
  ...
  backButton: { width: 42, height: 42, borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: palette.line, alignItems: 'center', justifyContent: 'center', shadowColor: '#0F172A', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 10, elevation: 2 },
  ...
  title: { color: palette.ink, fontSize: 28, lineHeight: 34, fontWeight: '600', letterSpacing: -0.8 },
  subtitle: { color: palette.muted, fontSize: 14, lineHeight: 22, marginTop: 8, fontWeight: '600' },
  body: { marginTop: 16, gap: 13 },
  fieldWrap: { gap: 8 },
  label: { color: '#334155', fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.6 },
  input: { minHeight: 55, borderRadius: 17, borderWidth: 1.5, borderColor: palette.line, backgroundColor: '#FFFFFF', paddingHorizontal: 16, color: palette.ink, fontSize: 15, fontWeight: '500' },
  ...
  sectionTitle: { color: palette.ink, fontSize: 18, fontWeight: '600' },
  ...
  progressText: { color: palette.muted, fontSize: 11, fontWeight: '500', marginTop: 8 },
  pill: { alignSelf: 'flex-start', borderRadius: 999, paddingHorizontal: 11, paddingVertical: 6 },
  pillText: { fontSize: 10, fontWeight: '600', letterSpacing: 0.6 },
});
