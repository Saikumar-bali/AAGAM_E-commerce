...
const styles = StyleSheet.create({
  ...
  storeChip: { paddingHorizontal: 16, paddingVertical: 12, borderRadius: 14, backgroundColor: '#E5E9E7', borderWidth: 1, borderColor: '#D9DEDC' },
  ...
  card: { backgroundColor: '#FFFFFF', borderRadius: 20, padding: 17, marginBottom: 16, borderWidth: 1, borderColor: '#E0E3E2', shadowColor: '#10241D', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 8, elevation: 2 },
  ...
  summaryCard: { flex: 1, minHeight: 160, borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E0E3E2', padding: 16 },
  summaryIcon: { width: 42, height: 42, borderRadius: 20, backgroundColor: '#E8F8EE', alignItems: 'center', justifyContent: 'center' },
  ...
  actionCard: { minHeight: 86, borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E0E3E2', padding: 16, flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 12 },
