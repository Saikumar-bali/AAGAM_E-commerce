...
const styles = StyleSheet.create({
  ...
  totalText: { fontSize: 13, fontWeight: '600', color: '#0F172A', marginTop: 6 },
  ...
  navBtnText: { fontSize: 12, fontWeight: '500', color: '#3B82F6' },
  startBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, borderRadius: 10, backgroundColor: '#2563EB', paddingVertical: 12 },
  startBtnText: { fontSize: 13, fontWeight: '600', color: '#FFF' },
  completeBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, borderRadius: 10, backgroundColor: '#059669', paddingVertical: 12 },
  completeBtnText: { fontSize: 13, fontWeight: '600', color: '#FFF' },
  failBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4, borderRadius: 10, backgroundColor: '#DC2626', paddingVertical: 12, paddingHorizontal: 12 },
  failBtnText: { fontSize: 13, fontWeight: '600', color: '#FFF' },
  ...
  deliveredText: { fontSize: 12, fontWeight: '600', color: '#065F46' },
  card: { backgroundColor: '#FFF', borderRadius: 16, padding: 16, marginBottom: 16, borderWidth: 1, borderColor: '#E2E8F0' },
  cardLabel: { fontSize: 11, fontWeight: '600', color: '#94A3B8', textTransform: 'uppercase', letterSpacing: 1 },
