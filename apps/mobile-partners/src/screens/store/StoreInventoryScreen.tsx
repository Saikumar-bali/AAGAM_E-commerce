...
const styles = StyleSheet.create({
  ...
  heroIconButton: { width: 44, height: 44, borderRadius: 12, backgroundColor: 'rgba(255,255,255,0.15)', alignItems: 'center', justifyContent: 'center' },
  ...
  bodySheet: { marginTop: -24, minHeight: 600, borderTopLeftRadius: 28, borderTopRightRadius: 28, backgroundColor: '#F7F8F7', paddingHorizontal: 18, paddingTop: 24 },
  pickerWrap: { marginBottom: 2 },
  storePicker: { minHeight: 72, borderRadius: 20, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DCE3E0', paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', gap: 12, shadowColor: '#10241D', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.06, shadowRadius: 10, elevation: 2 },
  storeIcon: { width: 44, height: 44, borderRadius: 12, backgroundColor: '#E8F8EE', alignItems: 'center', justifyContent: 'center' },
  ...
  storeOption: { minHeight: 49, paddingHorizontal: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderBottomWidth: 1, borderBottomColor: '#EDF0EE' },
  storeOptionActive: { backgroundColor: '#EDF9F2' },
  storeOptionText: { color: '#334155', fontWeight: '600' },
  singleStoreBanner: { minHeight: 72, paddingHorizontal: 16, borderRadius: 20, backgroundColor: '#E8F8EE', borderWidth: 1, borderColor: '#A9E5C8', flexDirection: 'row', alignItems: 'center', gap: 12 },
  singleStoreName: { color: '#075E43', fontSize: 15, fontWeight: '600' },
  singleStoreAddress: { color: '#29755D', fontSize: 11, marginTop: 4 },
  statsRow: { flexDirection: 'row', gap: 8, marginTop: 16 },
  statCard: { flex: 1, minHeight: 92, backgroundColor: '#FFFFFF', borderRadius: 16, padding: 12, borderWidth: 1, borderColor: '#DEE3E1', shadowColor: '#10241D', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.04, shadowRadius: 8, elevation: 1 },
  ...
  tab: { flex: 1, minHeight: 54, borderRadius: 16, backgroundColor: '#E6EBE8', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  ...
  emptyCard: { minHeight: 200, borderRadius: 20, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DEE3E1', marginTop: 8 },
  ...
  primaryButton: { minHeight: 48, borderRadius: 16, backgroundColor: ACTION_GREEN, paddingHorizontal: 20, alignItems: 'center', justifyContent: 'center', marginTop: 16 },
  primaryButtonText: { color: '#FFFFFF', fontWeight: '600' },
  productCard: { marginTop: 12, borderRadius: 20, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DEE3E1', padding: 16, shadowColor: '#10241D', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.05, shadowRadius: 11, elevation: 2 },
  ...
  warningBanner: { marginTop: 12, borderRadius: 12, padding: 12, backgroundColor: '#FFFBEB', flexDirection: 'row', alignItems: 'center', gap: 8 },
  ...
  policyRow: { flexDirection: 'row', gap: 8, marginTop: 12 },
  ...
  loadMoreButton: { minHeight: 50, borderRadius: 15, backgroundColor: ACTION_GREEN, alignItems: 'center', justifyContent: 'center', marginTop: 16 },
});
