...
const styles = StyleSheet.create({
  fab: { position: 'absolute', top: 54, right: 12, zIndex: 50, elevation: 18, minHeight: 40, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#056B49', paddingHorizontal: 12, borderRadius: 18, shadowColor: '#000', shadowOpacity: 0.18, shadowRadius: 10, shadowOffset: { width: 0, height: 4 } },
