...
const styles = StyleSheet.create({
  fab: { position: 'absolute', bottom: 84, right: 16, zIndex: 50, elevation: 18, minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#0F766E', paddingHorizontal: 14, borderRadius: 20, shadowColor: '#0F766E', shadowOpacity: 0.3, shadowRadius: 12, shadowOffset: { width: 0, height: 4 } },
  ...
  header: { backgroundColor: '#0F766E', paddingTop: 52, paddingHorizontal: 20, paddingBottom: 20, flexDirection: 'row', gap: 14, alignItems: 'flex-start' },
  ...
  content: { padding: 16, paddingBottom: 40, gap: 14 }, state: { minHeight: 260, borderRadius: 24, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center', padding: 24 }, stateTitle: { marginTop: 10, color: '#14221D', fontSize: 17, fontWeight: '600' }, stateText: { marginTop: 8, color: '#69746F', textAlign: 'center', lineHeight: 19, fontWeight: '600' }, retry: { marginTop: 14, minHeight: 44, paddingHorizontal: 18, borderRadius: 14, backgroundColor: '#0F766E', flexDirection: 'row', alignItems: 'center', gap: 8 }, retryText: { color: '#FFFFFF', fontWeight: '600' },
  card: { backgroundColor: '#FFFFFF', borderRadius: 24, borderWidth: 1, borderColor: '#DFE7E2', padding: 16, shadowColor: '#163A2D', shadowOpacity: 0.06, shadowRadius: 10, shadowOffset: { width: 0, height: 4 }, elevation: 2 }, cardDanger: { borderColor: '#FCA5A5' }, cardTop: { flexDirection: 'row', gap: 10, alignItems: 'flex-start' }, date: { color: '#0F766E', fontSize: 10, fontWeight: '600', letterSpacing: 0.7 }, plan: { color: '#17221E', fontSize: 18, fontWeight: '600', marginTop: 4 }, meta: { color: '#75807B', fontSize: 11, fontWeight: '500', marginTop: 4 },
  status: { borderRadius: 99, paddingHorizontal: 10, paddingVertical: 6 }, statusReady: { backgroundColor: '#D9F8E8' }, statusPending: { backgroundColor: '#FEF3C7' }, statusDanger: { backgroundColor: '#FEE2E2' }, statusText: { color: '#34423C', fontSize: 9, fontWeight: '600' },
  infoBlock: { marginTop: 12, backgroundColor: '#F7F9F8', borderRadius: 16, padding: 12 }, infoTitle: { flexDirection: 'row', gap: 6, alignItems: 'center' }, infoLabel: { color: '#6B7671', fontSize: 9, fontWeight: '600', letterSpacing: 0.7 }, chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 8 }, chip: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E7E4', borderRadius: 99, paddingHorizontal: 10, paddingVertical: 6 }, chipText: { color: '#27342F', fontSize: 11, fontWeight: '600' },
  ...
  shortage: { marginTop: 8, borderRadius: 14, backgroundColor: '#FFF1F2', padding: 10, flexDirection: 'row', gap: 8, alignItems: 'flex-start' }, shortageText: { flex: 1, color: '#B42318', fontSize: 11, fontWeight: '600', lineHeight: 16 }, input: { minHeight: 70, marginTop: 10, borderWidth: 1, borderColor: '#D9E2DD', backgroundColor: '#FFFFFF', borderRadius: 14, paddingHorizontal: 11, paddingVertical: 8, textAlignVertical: 'top', color: '#26342E', fontSize: 12, fontWeight: '600' }, actions: { flexDirection: 'row', gap: 8, marginTop: 10 }, readyButton: { flex: 1, minHeight: 44, borderRadius: 14, backgroundColor: '#0F766E', flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center' }, shortageButton: { flex: 1, minHeight: 44, borderRadius: 14, backgroundColor: '#FFF1F2', flexDirection: 'row', gap: 8, alignItems: 'center', justifyContent: 'center' }, actionText: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' }, shortageActionText: { color: '#B42318', fontSize: 12, fontWeight: '600' }, footnote: { marginTop: 8, color: '#7A8580', fontSize: 10, fontWeight: '600', lineHeight: 15 },
});
