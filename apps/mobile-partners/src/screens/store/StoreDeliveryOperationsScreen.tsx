  ...
  const submitInspection = (job: any) => {
    try {
      ...
      Alert.alert(
        ...
        'Only sellable items return to inventory.',
        [
          { text: 'Cancel', style: 'cancel' },
          {
            ...
            onPress: () => void perform(
              ...
              'Sellable items restored to inventory.',
            ),
          },
        ],
      );
                ...
                <View style={styles.actionSection}>
                  <View style={styles.sectionHeader}>
                    ...
                    <View style={styles.sectionCopy}>
                      ...
                      <Text style={styles.sectionText}>Confirm after receiving the parcel from the rider.</Text>
                    </View>
                  </View>
                  <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  muted: { color: '#64748B' },
  emptyCard: { margin: 20, minHeight: 250, borderRadius: 24, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E7E5E4', alignItems: 'center', justifyContent: 'center', padding: 28 },
  emptyTitle: { marginTop: 16, color: '#0F172A', fontSize: 19, fontWeight: '600' },
  ...
  errorTitle: { color: '#991B1B', fontSize: 18, fontWeight: '600', marginTop: 12 },
  errorText: { color: '#B91C1C', textAlign: 'center', marginTop: 8 },
  jobCard: { marginHorizontal: 18, marginTop: 16, borderRadius: 24, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E7E5E4', padding: 18 },
  jobTop: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 12 },
  orderId: { color: '#0F766E', fontSize: 10, fontWeight: '600', letterSpacing: 1.1 },
  status: { color: '#0F172A', fontSize: 18, fontWeight: '600', marginTop: 4 },
  meta: { color: '#64748B', fontSize: 12, marginTop: 4, maxWidth: 220 },
  totalBox: { alignItems: 'flex-end' },
  totalLabel: { color: '#B45309', fontSize: 10, fontWeight: '600' },
  total: { color: '#0F172A', fontSize: 17, fontWeight: '600', marginTop: 4 },
  ...
  sectionText: { color: '#64748B', fontSize: 11, lineHeight: 17, marginTop: 4 },
  warningButton: { minHeight: 49, borderRadius: 15, backgroundColor: '#B45309', marginTop: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  ...
  quantityRow: { flexDirection: 'row', gap: 8, marginTop: 12 },
  quantityField: { flex: 1 },
  quantityLabel: { color: '#64748B', fontSize: 9, fontWeight: '600', textTransform: 'uppercase' },
  quantityInput: { height: 42, borderRadius: 11, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#FFFFFF', color: '#0F172A', textAlign: 'center', fontWeight: '600', marginTop: 4 },
  ...
  referenceInput: { height: 50, borderRadius: 14, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#F8FAFC', marginTop: 12, paddingHorizontal: 12, color: '#0F172A', fontWeight: '600' },
  completedBanner: { marginTop: 12, borderRadius: 14, borderWidth: 1, borderColor: '#BBF7D0', backgroundColor: '#F0FDF4', padding: 12, flexDirection: 'row', alignItems: 'center', gap: 8 },
  completedText: { color: '#166534', fontSize: 12, fontWeight: '600' },
  pendingBanner: { marginTop: 12, borderRadius: 14, borderWidth: 1, borderColor: '#FDE68A', backgroundColor: '#FFFBEB', padding: 12, flexDirection: 'row', alignItems: 'center', gap: 8 },
  pendingText: { flex: 1, color: '#92400E', fontSize: 11, fontWeight: '600' },
  auditSection: { marginTop: 16, borderTopWidth: 1, borderTopColor: '#F1F5F9', paddingTop: 14 },
  auditHeading: { color: '#475569', fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 1 },
  auditRow: { paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#F8FAFC' },
  auditType: { color: '#334155', fontSize: 11, fontWeight: '600' },
  ...
  pickupBannerTitle: { color: '#FFFFFF', fontSize: 15, fontWeight: '600' },
  pickupBannerText: { color: '#CCFBF1', fontSize: 11, fontWeight: '600', marginTop: 4 },
});
