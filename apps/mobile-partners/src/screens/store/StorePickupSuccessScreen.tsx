...
const styles = StyleSheet.create({
  ...
  receiptCard: { marginHorizontal: 17, marginTop: -35, borderRadius: 20, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DFE3E1', padding: 20, elevation: 5, shadowColor: '#17261F', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 12 },
  ...
  successBanner: { minHeight: 92, marginHorizontal: 17, marginTop: 18, borderRadius: 16, borderWidth: 1, borderColor: '#BFE7CE', backgroundColor: '#EAF9EE', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 18, gap: 16 },
  successIcon: { width: 52, height: 52, borderRadius: 24, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center' },
