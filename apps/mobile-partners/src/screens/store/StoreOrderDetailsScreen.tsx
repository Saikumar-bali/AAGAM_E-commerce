...
const styles = StyleSheet.create({
  ...
  statusChip: { maxWidth: 132, borderRadius: 999, paddingHorizontal: 12, paddingVertical: 8 },
  ...
  section: { marginTop: 16, borderRadius: 20, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E0E3E2', padding: 16 },
  ...
  replacements: { marginTop: 12, paddingTop: 10, borderTopWidth: 1, borderTopColor: '#E0E3E2' },
  replacementLabel: { color: '#697078', fontSize: 10, fontWeight: '600', marginBottom: 4 },
  replacement: { minHeight: 48, flexDirection: 'row', alignItems: 'center', borderRadius: 12, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E6E9E7', paddingHorizontal: 12, marginTop: 6 },
  replacementName: { color: '#15181C', fontSize: 12, fontWeight: '600' },
  info: { flexDirection: 'row', alignItems: 'flex-start', gap: 8, marginTop: 12 },
  ...
  actionsCard: { marginTop: 16, borderRadius: 20, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E0E3E2', padding: 16, gap: 8 },
