...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: '#0F766E', paddingHorizontal: 18, paddingTop: 22, paddingBottom: 21, borderBottomLeftRadius: 30, borderBottomRightRadius: 30 }, headerRow: { flexDirection: 'row', alignItems: 'center' }, backButton: { width: 44, height: 44, borderRadius: 15, backgroundColor: 'rgba(255,255,255,0.13)', alignItems: 'center', justifyContent: 'center' }, headerCopy: { flex: 1, marginLeft: 12 }, heroEyebrow: { color: '#BAF3DD', fontSize: 10, letterSpacing: 1.2, fontWeight: '600' }, heroTitle: { color: '#FFFFFF', fontSize: 22, fontWeight: '600', marginTop: 2 }, routeIcon: { width: 48, height: 48, borderRadius: 16, backgroundColor: '#ECFFF7', alignItems: 'center', justifyContent: 'center' }, storeAddressRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 7, marginTop: 14 }, storeAddressText: { flex: 1, color: '#D7F8EA', fontSize: 12, lineHeight: 18 }, progressHeader: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 18 }, progressTitle: { color: '#FFFFFF', fontSize: 13, fontWeight: '600' }, progressPercent: { color: '#BAF3DD', fontSize: 13, fontWeight: '600' }, progressTrack: { height: 8, borderRadius: 4, backgroundColor: 'rgba(255,255,255,0.18)', overflow: 'hidden', marginTop: 8 }, progressFill: { height: 8, borderRadius: 4, backgroundColor: '#6EE7B7' }, routeStats: { flexDirection: 'row', marginTop: 17, paddingVertical: 12, borderRadius: 17, backgroundColor: 'rgba(255,255,255,0.11)' }, routeStat: { flex: 1, alignItems: 'center' }, routeStatValue: { color: '#FFFFFF', fontSize: 17, fontWeight: '600' }, routeStatLabel: { color: '#CFF7E6', fontSize: 10, marginTop: 2 }, routeStatDivider: { width: 1, backgroundColor: 'rgba(255,255,255,0.22)' },
  stickyPrimary: { minHeight: 54, margin: 16, marginBottom: 0, borderRadius: 17, backgroundColor: '#0F766E', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9 }, stickyPrimaryText: { color: '#FFFFFF', fontSize: 15, fontWeight: '600' }, offlinePendingCard: { margin: 16, marginBottom: 0, borderRadius: 18, backgroundColor: '#FFF5DE', borderWidth: 1, borderColor: '#F0D9A7', padding: 15, flexDirection: 'row', gap: 11 }, noticeCard: { margin: 16, marginBottom: 0, borderRadius: 18, backgroundColor: '#FFF5DE', borderWidth: 1, borderColor: '#F0D9A7', padding: 15, flexDirection: 'row', gap: 11 }, noticeCopy: { flex: 1 }, noticeTitle: { color: '#704000', fontSize: 14, fontWeight: '600' }, noticeText: { color: '#8A5A14', fontSize: 12, lineHeight: 18, marginTop: 2 },
  nextStopCard: { margin: 16, marginBottom: 0, borderRadius: 20, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#B8DDCE', padding: 15, flexDirection: 'row', alignItems: 'center', shadowColor: '#0F2A20', shadowOffset: { width: 0, height: 5 }, shadowOpacity: 0.08, shadowRadius: 10, elevation: 4 }, nextStopIcon: { width: 48, height: 48, borderRadius: 16, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center' }, nextStopCopy: { flex: 1, marginHorizontal: 12 }, nextStopEyebrow: { color: '#0F766E', fontSize: 10, fontWeight: '600', letterSpacing: 1 }, nextStopName: { color: '#17211D', fontSize: 16, fontWeight: '600', marginTop: 2 }, nextStopAddress: { color: '#64748B', fontSize: 11, marginTop: 2 },
