...
const styles = StyleSheet.create({
  ...
  title: { color: '#0F172A', fontSize: 20, fontWeight: '600', marginTop: 12, textAlign: 'center' },
  hint: { color: '#64748B', fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 8 },
  primary: { marginTop: 18, minHeight: 48, borderRadius: 14, backgroundColor: '#0F766E', paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  primaryText: { color: '#FFFFFF', fontWeight: '600' },
  secondary: { marginTop: 8, minHeight: 48, borderRadius: 14, borderWidth: 1, borderColor: '#99D8C8', paddingHorizontal: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
