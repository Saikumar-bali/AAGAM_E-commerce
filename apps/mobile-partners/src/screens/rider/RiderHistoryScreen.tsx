...
const styles = StyleSheet.create({
  ...
  chip: { minHeight: 40, borderRadius: 20, borderWidth: 1, borderColor: '#CBD5E1', paddingHorizontal: 16, alignItems: 'center', justifyContent: 'center' },
  chipActive: { backgroundColor: '#0F766E', borderColor: '#0F766E' },
  chipText: { color: '#475569', fontSize: 12, fontWeight: '600' },
  chipTextActive: { color: '#FFFFFF' },
  rangeArea: { backgroundColor: '#FFFFFF', borderTopWidth: 1, borderTopColor: '#E2E8F0', borderBottomWidth: 1, borderBottomColor: '#E2E8F0', paddingHorizontal: 14, paddingVertical: 10, flexDirection: 'row', alignItems: 'center', gap: 8 },
  rangeRail: { gap: 8 },
  ...
  rangeText: { color: '#64748B', fontSize: 11, fontWeight: '600' },
  rangeTextActive: { color: '#0F766E' },
  list: { flex: 1 },
  listContent: { padding: 14 },
  resultText: { color: '#64748B', fontSize: 11, fontWeight: '500', marginBottom: 8 },
  card: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 16, marginBottom: 11 },
  cardHeader: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  orderCode: { color: '#0F172A', fontSize: 13, fontWeight: '600' },
  date: { color: '#64748B', fontSize: 11, marginTop: 4 },
  badge: { borderRadius: 10, paddingHorizontal: 10, paddingVertical: 6 },
  badgeText: { fontSize: 10, fontWeight: '600' },
  store: { color: '#0F766E', fontSize: 14, fontWeight: '600', marginTop: 12 },
  address: { color: '#475569', fontSize: 12, lineHeight: 18, marginTop: 4 },
  cardFooter: { borderTopWidth: 1, borderTopColor: '#E2E8F0', marginTop: 12, paddingTop: 12, flexDirection: 'row', alignItems: 'center' },
  amount: { flex: 1, color: '#0F172A', fontSize: 16, fontWeight: '600' },
  openRow: { flexDirection: 'row', alignItems: 'center', gap: 4 },
  openText: { color: '#0F766E', fontSize: 12, fontWeight: '600' },
  state: { minHeight: 280, alignItems: 'center', justifyContent: 'center', padding: 30 },
  stateTitle: { color: '#0F172A', fontSize: 18, fontWeight: '600', marginTop: 12, textAlign: 'center' },
