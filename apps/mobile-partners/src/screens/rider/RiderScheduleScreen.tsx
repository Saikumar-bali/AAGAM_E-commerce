...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#F8FAFC' }, flex: { flex: 1 }, header: { backgroundColor: '#0F766E', paddingHorizontal: 16, paddingBottom: 18, flexDirection: 'row', alignItems: 'center', gap: 12 }, back: { width: 44, height: 44, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.14)', alignItems: 'center', justifyContent: 'center' }, eyebrow: { color: '#A7F3D0', fontSize: 9, fontWeight: '600', letterSpacing: 1 }, title: { color: '#FFFFFF', fontSize: 22, fontWeight: '600' }, content: { padding: 14 },
  timezoneCard: { borderRadius: 17, backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#99F6E4', padding: 14, flexDirection: 'row', gap: 10 }, timezoneLabel: { color: '#64748B', fontSize: 10, fontWeight: '600' }, timezoneValue: { color: '#0F172A', fontSize: 16, fontWeight: '600', marginTop: 2 }, timezoneMeta: { color: '#475569', fontSize: 10, lineHeight: 15, marginTop: 4 },
  dayCard: { marginTop: 10, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 12 }, dayHeader: { flexDirection: 'row', alignItems: 'center' }, dayName: { color: '#0F172A', fontSize: 15, fontWeight: '600' }, dayMeta: { color: '#64748B', fontSize: 10, marginTop: 2 }, addButton: { minHeight: 38, borderRadius: 11, backgroundColor: '#CCFBF1', paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center', gap: 4 }, addText: { color: '#0F766E', fontWeight: '600', fontSize: 11 }, offText: { color: '#94A3B8', fontSize: 12, marginTop: 12 },
  windowRow: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 11 }, timeButton: { flex: 1, minHeight: 51, borderRadius: 12, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#F8FAFC', paddingHorizontal: 11, justifyContent: 'center' }, timeLabel: { color: '#64748B', fontSize: 9, fontWeight: '600' }, timeValue: { color: '#0F172A', fontSize: 13, fontWeight: '600', marginTop: 2 }, to: { color: '#64748B', fontSize: 11 }, deleteButton: { width: 43, height: 51, borderRadius: 12, backgroundColor: '#FEF2F2', alignItems: 'center', justifyContent: 'center' },
  copyRow: { flexDirection: 'row', gap: 8, marginTop: 11 }, copyButton: { flex: 1, minHeight: 40, borderRadius: 11, backgroundColor: '#F0FDFA', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 }, copyText: { color: '#0F766E', fontSize: 10, fontWeight: '600' }, doneButton: { alignSelf: 'flex-end', padding: 10 }, doneText: { color: '#0F766E', fontWeight: '600' },
  errorCard: { borderRadius: 13, backgroundColor: '#FEF2F2', borderWidth: 1, borderColor: '#FECACA', padding: 12, marginTop: 10 }, errorText: { color: '#B91C1C', fontSize: 11, fontWeight: '600' }, primary: { minHeight: 52, borderRadius: 14, backgroundColor: '#0F766E', marginTop: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, primaryText: { color: '#FFFFFF', fontWeight: '600' }, disabled: { opacity: 0.45 },
  card: { marginTop: 12, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 14 }, sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 8 }, sectionTitle: { color: '#0F172A', fontSize: 16, fontWeight: '600' }, emptyText: { color: '#64748B', fontSize: 11, marginTop: 12 }, shiftRow: { flexDirection: 'row', gap: 10, paddingVertical: 10 }, shiftDot: { width: 9, height: 9, borderRadius: 5, backgroundColor: '#0F766E', marginTop: 4 }, shiftTitle: { color: '#0F172A', fontSize: 12, fontWeight: '600' }, shiftMeta: { color: '#64748B', fontSize: 10, marginTop: 4 }, shiftNote: { color: '#334155', fontSize: 10, marginTop: 4 },
  input: { minHeight: 49, borderRadius: 12, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#F8FAFC', paddingHorizontal: 12, color: '#0F172A', marginTop: 11 }, breakText: { color: '#475569', fontSize: 11, lineHeight: 17, marginTop: 10 }, secondary: { minHeight: 48, borderRadius: 13, borderWidth: 1, borderColor: '#99D8C8', marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, secondaryText: { color: '#0F766E', fontWeight: '600' }, state: { minHeight: 420, alignItems: 'center', justifyContent: 'center' },
});
