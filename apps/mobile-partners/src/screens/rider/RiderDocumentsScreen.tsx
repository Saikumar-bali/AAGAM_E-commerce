...
const styles = StyleSheet.create({
  ...
  listTitle: { color: '#0F172A', fontSize: 17, fontWeight: '900', marginTop: 18, marginBottom: 9 }, errorBanner: { marginBottom: 10, borderRadius: 15, borderWidth: 1, borderColor: '#FCD34D', backgroundColor: '#FFFBEB', padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10 }, errorBannerTitle: { color: '#92400E', fontSize: 11, fontWeight: '900' }, errorBannerText: { color: '#B45309', fontSize: 10, marginTop: 3 }, errorRetry: { color: '#0F766E', fontWeight: '900' }, documentCard: { borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 13, marginBottom: 9, flexDirection: 'row', alignItems: 'center', gap: 10 }, documentWarning: { borderColor: '#FCD34D', backgroundColor: '#FFFBEB' },
