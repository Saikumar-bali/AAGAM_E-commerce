...
const styles = StyleSheet.create({
  ...
  input: { minHeight: 50, borderRadius: 13, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#F8FAFC', paddingHorizontal: 12, color: '#0F172A' },
  dateButton: { minHeight: 52, borderRadius: 13, borderWidth: 1, borderColor: '#CBD5E1', marginTop: 10, paddingHorizontal: 12, justifyContent: 'center' }, dateLabel: { color: '#64748B', fontSize: 9, fontWeight: '600' }, dateValue: { color: '#0F172A', fontSize: 13, fontWeight: '600', marginTop: 2 },
  pickRow: { flexDirection: 'row', gap: 8, marginTop: 10 }, pickButton: { flex: 1, minHeight: 48, borderRadius: 13, backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#99F6E4', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, pickText: { color: '#0F766E', fontWeight: '600' },
  fileRow: { borderRadius: 13, backgroundColor: '#F0FDF4', padding: 12, marginTop: 10, flexDirection: 'row', alignItems: 'center', gap: 8 }, fileName: { color: '#166534', fontSize: 12, fontWeight: '600' }, fileMeta: { color: '#15803D', fontSize: 9, marginTop: 2 },
  primary: { minHeight: 50, borderRadius: 14, backgroundColor: '#0F766E', marginTop: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, primaryText: { color: '#FFFFFF', fontWeight: '600' }, disabled: { opacity: 0.45 },
  listTitle: { color: '#0F172A', fontSize: 17, fontWeight: '600', marginTop: 18, marginBottom: 8 }, errorBanner: { marginBottom: 10, borderRadius: 15, borderWidth: 1, borderColor: '#FCD34D', backgroundColor: '#FFFBEB', padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10 }, errorBannerTitle: { color: '#92400E', fontSize: 11, fontWeight: '600' }, errorBannerText: { color: '#B45309', fontSize: 10, marginTop: 4 }, errorRetry: { color: '#0F766E', fontWeight: '600' }, documentCard: { borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 12, marginBottom: 8, flexDirection: 'row', alignItems: 'center', gap: 10 }, documentWarning: { borderColor: '#FCD34D', backgroundColor: '#FFFBEB' },
  documentIcon: { width: 43, height: 43, borderRadius: 13, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' }, warningIcon: { backgroundColor: '#FEF3C7' }, documentTitle: { color: '#0F172A', fontSize: 12, fontWeight: '600' }, documentMeta: { color: '#64748B', fontSize: 9, lineHeight: 14, marginTop: 4 }, warningText: { color: '#B45309', fontWeight: '600' }, reviewNote: { color: '#7F1D1D', fontSize: 10, lineHeight: 15, marginTop: 4 },
  state: { minHeight: 220, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 24 }, stateTitle: { color: '#0F172A', fontSize: 17, fontWeight: '600', marginTop: 8 }, stateText: { color: '#64748B', fontSize: 11, lineHeight: 17, textAlign: 'center', marginTop: 6 },
});
