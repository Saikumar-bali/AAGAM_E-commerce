...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#F8FAFC' }, flex: { flex: 1 }, header: { backgroundColor: '#0F766E', paddingHorizontal: 16, paddingBottom: 18, flexDirection: 'row', alignItems: 'center', gap: 12 }, back: { width: 44, height: 44, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.14)', alignItems: 'center', justifyContent: 'center' }, eyebrow: { color: '#A7F3D0', fontSize: 9, fontWeight: '600', letterSpacing: 1 }, title: { color: '#FFFFFF', fontSize: 22, fontWeight: '600' }, timer: { color: '#FFFFFF', fontSize: 15, fontWeight: '600' }, content: { padding: 14 },
  orderCard: { minHeight: 72, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 14, flexDirection: 'row', alignItems: 'center', gap: 12 }, smallLabel: { color: '#0F766E', fontSize: 9, fontWeight: '600' }, orderValue: { color: '#0F172A', fontSize: 16, fontWeight: '600', marginTop: 2 }, itemCount: { color: '#475569', fontSize: 11, fontWeight: '600' },
  ...
  state: { minHeight: 520, alignItems: 'center', justifyContent: 'center', padding: 28 }, stateTitle: { color: '#0F172A', fontSize: 20, fontWeight: '600', marginTop: 12, textAlign: 'center' }, stateText: { color: '#64748B', fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 8 },
});
