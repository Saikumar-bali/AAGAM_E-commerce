...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#F8FAFC' }, flex: { flex: 1 }, header: { backgroundColor: '#0F766E', paddingHorizontal: 16, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', gap: 8 }, eyebrow: { color: '#A7F3D0', fontSize: 9, fontWeight: '600', letterSpacing: 1 }, headerTitle: { color: '#FFFFFF', fontSize: 21, fontWeight: '600', marginTop: 2 }, headerButton: { width: 42, height: 42, borderRadius: 13, backgroundColor: 'rgba(255,255,255,0.14)', alignItems: 'center', justifyContent: 'center' }, notificationBadge: { position: 'absolute', right: -3, top: -4, minWidth: 18, height: 18, borderRadius: 9, backgroundColor: '#EF4444', alignItems: 'center', justifyContent: 'center' }, notificationBadgeText: { color: '#FFFFFF', fontSize: 8, fontWeight: '600' }, content: { padding: 14 },
  progressCard: { borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 12, flexDirection: 'row', alignItems: 'flex-start' }, stepItem: { width: 54, alignItems: 'center' }, stepDot: { width: 31, height: 31, borderRadius: 16, backgroundColor: '#E2E8F0', alignItems: 'center', justifyContent: 'center' }, stepDone: { backgroundColor: '#15803D' }, stepActive: { backgroundColor: '#0F766E' }, stepLabel: { color: '#94A3B8', fontSize: 8, fontWeight: '600', marginTop: 4, textAlign: 'center' }, stepLabelActive: { color: '#0F172A' }, stepLine: { flex: 1, height: 3, backgroundColor: '#E2E8F0', marginTop: 14 }, stepLineDone: { backgroundColor: '#15803D' },
  destinationCard: { marginTop: 10, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 14, flexDirection: 'row', gap: 12 }, avatar: { width: 48, height: 48, borderRadius: 15, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' }, avatarText: { color: '#0F766E', fontSize: 20, fontWeight: '600' }, destinationLabel: { color: '#0F766E', fontSize: 9, fontWeight: '600' }, destinationName: { color: '#0F172A', fontSize: 16, fontWeight: '600', marginTop: 4 }, address: { color: '#64748B', fontSize: 10, lineHeight: 16, marginTop: 4 }, orderCode: { color: '#475569', fontSize: 9, fontWeight: '600', marginTop: 4 },
  contactCard: { marginTop: 10, borderRadius: 17, backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#99F6E4', padding: 14 }, contactHeader: { flexDirection: 'row', gap: 8 }, contactTitle: { color: '#0F172A', fontSize: 13, fontWeight: '600' }, contactText: { color: '#475569', fontSize: 10, lineHeight: 15, marginTop: 4 }, contactActions: { flexDirection: 'row', gap: 8, marginTop: 11 }, contactButton: { flex: 1, minHeight: 46, borderRadius: 13, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#99D8C8', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, contactButtonText: { color: '#0F766E', fontSize: 11, fontWeight: '600' }, safetyButton: { minHeight: 44, borderRadius: 12, backgroundColor: '#FEF2F2', borderWidth: 1, borderColor: '#FECACA', marginTop: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, safetyText: { color: '#B91C1C', fontSize: 11, fontWeight: '600' },
  quickActionsCard: { marginTop: 10, borderRadius: 15, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#D7E3DF', padding: 9 }, quickActionsLabel: { color: '#64748B', fontSize: 8, fontWeight: '600', letterSpacing: 1, marginBottom: 8 }, quickActions: { flexDirection: 'row', gap: 8 }, quickAction: { flex: 1, minHeight: 48, borderRadius: 12, backgroundColor: '#ECFDF5', alignItems: 'center', justifyContent: 'center', gap: 4 }, quickActionText: { color: '#0F766E', fontSize: 8, fontWeight: '600' }, quickActionDanger: { backgroundColor: '#FEF2F2' }, quickActionDangerText: { color: '#B91C1C', fontSize: 8, fontWeight: '600' },
  errorCard: { marginTop: 10, borderRadius: 15, backgroundColor: '#FEF2F2', borderWidth: 1, borderColor: '#FECACA', padding: 12, flexDirection: 'row', gap: 8 }, errorTitle: { color: '#991B1B', fontSize: 12, fontWeight: '600' }, errorText: { color: '#7F1D1D', fontSize: 10, lineHeight: 15, marginTop: 4 },
  primaryButton: { minHeight: 51, borderRadius: 14, backgroundColor: '#0F766E', marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, primaryText: { color: '#FFFFFF', fontWeight: '600' }, disabled: { opacity: 0.45 },
  card: { marginTop: 10, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 14 }, sectionHeader: { flexDirection: 'row', alignItems: 'center', gap: 8 }, sectionTitle: { color: '#0F172A', fontSize: 15, fontWeight: '600' }, hint: { color: '#64748B', fontSize: 10, lineHeight: 15, marginTop: 6 }, secondaryButton: { minHeight: 47, borderRadius: 13, backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#99F6E4', marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, secondaryText: { color: '#0F766E', fontWeight: '600' }, codButton: { minHeight: 47, borderRadius: 13, backgroundColor: '#FEF3C7', marginTop: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, codText: { color: '#92400E', fontWeight: '600' }, successStrip: { borderRadius: 12, backgroundColor: '#F0FDF4', padding: 10, marginTop: 8, flexDirection: 'row', alignItems: 'center', gap: 8 }, successText: { color: '#166534', fontSize: 11, fontWeight: '600' }, input: { minHeight: 49, borderRadius: 12, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#F8FAFC', paddingHorizontal: 12, color: '#0F172A', marginTop: 8 }, otpInput: { letterSpacing: 8, fontSize: 18, textAlign: 'center' }, confirmRow: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 8 }, checkbox: { width: 25, height: 25, borderRadius: 8, borderWidth: 1, borderColor: '#94A3B8', alignItems: 'center', justifyContent: 'center' }, checkboxChecked: { backgroundColor: '#0F766E', borderColor: '#0F766E' }, confirmText: { color: '#0F172A', fontSize: 12, fontWeight: '600' }, locationNote: { borderRadius: 12, backgroundColor: '#F0FDFA', padding: 10, marginTop: 8, flexDirection: 'row', gap: 8 }, locationNoteText: { flex: 1, color: '#0F766E', fontSize: 9, lineHeight: 14 },
  failureCard: { marginTop: 10, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#FECACA', overflow: 'hidden' }, failureHeader: { minHeight: 68, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 8 }, failureTitle: { color: '#991B1B', fontSize: 13, fontWeight: '600' }, failureText: { color: '#7F1D1D', fontSize: 10, marginTop: 4 }, failureToggle: { color: '#B91C1C', fontSize: 10, fontWeight: '600' }, failureBody: { borderTopWidth: 1, borderTopColor: '#FECACA', padding: 12 }, reasonRail: { gap: 8 }, reasonChip: { minHeight: 36, borderRadius: 11, backgroundColor: '#FEF2F2', paddingHorizontal: 11, justifyContent: 'center' }, reasonChipSelected: { backgroundColor: '#B91C1C' }, reasonText: { color: '#991B1B', fontSize: 9, fontWeight: '600' }, reasonTextSelected: { color: '#FFFFFF' }, multiline: { minHeight: 95, paddingTop: 11, textAlignVertical: 'top' }, failureButton: { minHeight: 48, borderRadius: 13, backgroundColor: '#B91C1C', marginTop: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, failureButtonText: { color: '#FFFFFF', fontWeight: '600' },
  supportButton: { minHeight: 49, borderRadius: 14, borderWidth: 1, borderColor: '#99D8C8', marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, supportText: { color: '#0F766E', fontWeight: '600' },
  state: { flex: 1, minHeight: 480, alignItems: 'center', justifyContent: 'center', padding: 28, backgroundColor: '#F8FAFC' }, stateTitle: { color: '#0F172A', fontSize: 20, fontWeight: '600', marginTop: 12, textAlign: 'center' }, stateText: { color: '#64748B', fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 8 },
});
