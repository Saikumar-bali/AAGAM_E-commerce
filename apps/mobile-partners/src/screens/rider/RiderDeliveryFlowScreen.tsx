  ...
  return (
    <View style={styles.screen}>
      ...
      >
        ...
        <TouchableOpacity accessibilityRole="button" style={styles.supportButton} onPress={() => navigation.getParent()?.navigate('RiderSupport', { deliveryJobId: activeJob.id })}><LifeBuoy size={19} color="#0F766E" /><Text style={styles.supportText}>Support for this delivery</Text></TouchableOpacity>
      </ScrollView>
    </View>
  );
};
