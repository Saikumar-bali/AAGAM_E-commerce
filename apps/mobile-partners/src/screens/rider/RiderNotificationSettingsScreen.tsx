...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: '#0F172A', fontSize: 17, fontWeight: '600' },
  sectionHint: { color: '#64748B', fontSize: 12, lineHeight: 18, marginTop: 4, marginBottom: 11 },
  rowCard: { minHeight: 76, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 14, marginBottom: 8, flexDirection: 'row', alignItems: 'center', gap: 12 },
  rowTitle: { color: '#0F172A', fontSize: 14, fontWeight: '600' },
  rowText: { color: '#64748B', fontSize: 11, lineHeight: 16, marginTop: 4 },
  devicesTitle: { marginTop: 18 },
  deviceCard: { minHeight: 82, borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 12, marginBottom: 8, flexDirection: 'row', alignItems: 'center', gap: 12 },
  deviceIcon: { width: 42, height: 42, borderRadius: 14, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' },
  current: { color: '#047857', fontSize: 10, fontWeight: '600', marginTop: 4 },
  ...
  errorTitle: { color: '#991B1B', fontSize: 14, fontWeight: '600' },
  errorText: { color: '#B91C1C', fontSize: 11, marginTop: 4 },
  errorButton: { marginTop: 12, borderRadius: 12, backgroundColor: '#B91C1C', paddingHorizontal: 16, paddingVertical: 10 },
  ...
  inlineErrorTitle: { color: '#92400E', fontSize: 11, fontWeight: '600' },
  inlineErrorText: { color: '#B45309', fontSize: 10, marginTop: 4 },
  inlineRetry: { color: '#0F766E', fontWeight: '600' },
});
