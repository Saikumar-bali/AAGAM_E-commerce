...
const styles = StyleSheet.create({
  ...
  healthTitle: { color: '#0F172A', fontSize: 16, fontWeight: '600' },
  ...
  metricLabel: { color: '#475569', fontSize: 12, fontWeight: '600', flex: 1 },
  metricValue: { color: '#0F172A', fontSize: 11, fontWeight: '600', maxWidth: '48%', textAlign: 'right' },
  action: { minHeight: 50, borderRadius: 15, backgroundColor: '#0F766E', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 8 },
  actionText: { color: '#FFFFFF', fontSize: 14, fontWeight: '600' },
  secondaryAction: { minHeight: 50, borderRadius: 15, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#99D8C8', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, marginTop: 8 },
  secondaryActionText: { color: '#0F766E', fontSize: 14, fontWeight: '600' },
});
