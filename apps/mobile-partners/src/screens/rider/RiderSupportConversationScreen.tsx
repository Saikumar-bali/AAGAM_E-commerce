...
const styles = StyleSheet.create({
  ...
  closedCard: { borderRadius: 15, backgroundColor: '#E2E8F0', padding: 12, marginTop: 8, flexDirection: 'row', gap: 8 }, closedTitle: { color: '#334155', fontSize: 12, fontWeight: '600' }, closedText: { color: '#64748B', fontSize: 10, lineHeight: 15, marginTop: 4 },
  composer: { backgroundColor: '#FFFFFF', borderTopWidth: 1, borderTopColor: '#E2E8F0', paddingHorizontal: 10, paddingTop: 9 }, composerRow: { flexDirection: 'row', alignItems: 'flex-end', gap: 8 }, attach: { width: 42, height: 46, borderRadius: 13, backgroundColor: '#ECFDF5', alignItems: 'center', justifyContent: 'center' }, input: { flex: 1, minHeight: 46, maxHeight: 112, borderRadius: 15, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#F8FAFC', paddingHorizontal: 12, paddingVertical: 10, color: '#0F172A' }, send: { width: 46, height: 46, borderRadius: 14, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center' }, disabled: { opacity: 0.45 },
  fileChip: { alignSelf: 'flex-start', maxWidth: '88%', minHeight: 32, borderRadius: 10, backgroundColor: '#ECFDF5', paddingHorizontal: 10, marginBottom: 8, flexDirection: 'row', alignItems: 'center', gap: 8 }, fileName: { flexShrink: 1, color: '#0F766E', fontSize: 10, fontWeight: '600' }, remove: { color: '#B91C1C', fontSize: 18, fontWeight: '600' },
  state: { minHeight: 420, alignItems: 'center', justifyContent: 'center', padding: 28 }, stateTitle: { color: '#0F172A', fontSize: 18, fontWeight: '600' }, stateText: { color: '#64748B', textAlign: 'center', marginTop: 8 },
});
