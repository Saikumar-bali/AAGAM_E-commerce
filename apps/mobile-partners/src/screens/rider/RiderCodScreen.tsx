...
const styles = StyleSheet.create({
  ...
  heroIcon: { width: 54, height: 54, borderRadius: 17, backgroundColor: '#059669', alignItems: 'center', justifyContent: 'center' }, heroLabel: { color: '#A7F3D0', fontSize: 10, fontWeight: '600' }, heroAmount: { color: '#FFFFFF', fontSize: 27, fontWeight: '600', marginTop: 2 }, heroText: { color: '#CBD5E1', fontSize: 10, lineHeight: 15, marginTop: 4 },
  summaryRow: { flexDirection: 'row', gap: 8, marginTop: 10 }, summaryCard: { flex: 1, borderRadius: 15, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 12 }, summaryLabel: { color: '#64748B', fontSize: 9, fontWeight: '600' }, summaryValue: { color: '#0F172A', fontSize: 13, fontWeight: '600', marginTop: 4 },
  filters: { gap: 8, paddingVertical: 12 }, filter: { minHeight: 38, borderRadius: 12, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#CBD5E1', paddingHorizontal: 12, justifyContent: 'center' }, filterActive: { backgroundColor: '#0F766E', borderColor: '#0F766E' }, filterText: { color: '#475569', fontSize: 10, fontWeight: '600' }, filterTextActive: { color: '#FFFFFF' },
  sectionTitle: { color: '#0F172A', fontSize: 16, fontWeight: '600', marginBottom: 8 },
  ledgerCard: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 16, marginBottom: 11 }, ledgerAttention: { borderColor: '#FCD34D', backgroundColor: '#FFFBEB' }, ledgerHeader: { flexDirection: 'row', alignItems: 'center' }, orderCode: { color: '#0F172A', fontSize: 13, fontWeight: '600' }, ledgerStatus: { color: '#0F766E', fontSize: 10, fontWeight: '600', marginTop: 4 },
  amountGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 12 }, amountCell: { width: '47%', borderRadius: 12, backgroundColor: '#F8FAFC', padding: 12 }, amountLabel: { color: '#64748B', fontSize: 9, fontWeight: '600' }, amountValue: { color: '#0F172A', fontSize: 14, fontWeight: '600', marginTop: 4 }, strongAmount: { color: '#B45309' },
  fact: { paddingVertical: 8, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#E2E8F0' }, factLabel: { color: '#64748B', fontSize: 9, fontWeight: '600' }, factValue: { color: '#0F172A', fontSize: 12, lineHeight: 18, fontWeight: '500', marginTop: 4 }, danger: { color: '#B91C1C' },
  auditTitle: { color: '#0F172A', fontSize: 13, fontWeight: '600', marginTop: 12 }, auditRow: { flexDirection: 'row', gap: 8, paddingVertical: 8 }, auditDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#0F766E', marginTop: 4 }, auditType: { color: '#0F172A', fontSize: 11, fontWeight: '600' }, auditMeta: { color: '#64748B', fontSize: 9, lineHeight: 14, marginTop: 2 },
  actions: { flexDirection: 'row', gap: 8, marginTop: 11 }, secondaryAction: { flex: 1, minHeight: 45, borderRadius: 12, borderWidth: 1, borderColor: '#99D8C8', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, secondaryText: { color: '#0F766E', fontSize: 11, fontWeight: '600' },
  actionNote: { borderRadius: 12, backgroundColor: '#FEF3C7', padding: 12, marginTop: 8, flexDirection: 'row', alignItems: 'center', gap: 8 }, actionNoteText: { flex: 1, color: '#92400E', fontSize: 10, lineHeight: 15 },
  state: { minHeight: 260, alignItems: 'center', justifyContent: 'center', padding: 28 }, stateTitle: { color: '#0F172A', fontSize: 18, fontWeight: '600', marginTop: 10 }, stateText: { color: '#64748B', fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 6 },
});
