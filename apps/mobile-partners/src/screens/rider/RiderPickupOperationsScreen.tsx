...
const styles = StyleSheet.create({
  ...
  fieldGroup: { marginTop: 12 }, fieldLabelRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 }, fieldLabel: { color: '#334155', fontSize: 11, fontWeight: '600' }, fieldHelp: { color: '#64748B', fontSize: 9, lineHeight: 14, marginTop: 4 }, inputProgress: { color: '#64748B', fontSize: 9, fontWeight: '600' }, inputProgressReady: { color: '#15803D' }, inputReady: { borderColor: '#22C55E', backgroundColor: '#F0FDF4' },
  itemCard: { minHeight: 72, borderRadius: 14, backgroundColor: '#F8FAFC', borderWidth: 1, borderColor: '#E2E8F0', padding: 12, marginTop: 10, flexDirection: 'row', alignItems: 'center', gap: 8 }, itemMatched: { backgroundColor: '#F0FDF4', borderColor: '#86EFAC' }, itemName: { color: '#0F172A', fontSize: 12, fontWeight: '600' }, itemMeta: { color: '#15803D', fontSize: 10, fontWeight: '600', marginTop: 4 }, mismatch: { color: '#B45309' }, counter: { flexDirection: 'row', alignItems: 'center', gap: 8 }, counterButton: { width: 38, height: 38, borderRadius: 12, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' }, counterValue: { minWidth: 28, color: '#0F172A', fontSize: 17, fontWeight: '600', textAlign: 'center' },
  ...
  successCard: { borderRadius: 13, backgroundColor: '#F0FDF4', padding: 12, marginTop: 10, flexDirection: 'row', alignItems: 'center', gap: 8 }, successText: { flex: 1, color: '#166534', fontSize: 11, fontWeight: '600' }, primaryButton: { minHeight: 50, borderRadius: 14, backgroundColor: '#0F766E', marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, buttonText: { color: '#FFFFFF', fontWeight: '600' }, disabled: { opacity: 0.45 },
  handoffActions: { flexDirection: 'row', gap: 8, marginTop: 10 }, handoffButton: { flex: 1, minHeight: 50, borderRadius: 14, backgroundColor: '#0F766E', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, qrButton: { flex: 1, minHeight: 50, borderRadius: 14, backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#99F6E4', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, qrText: { color: '#0F766E', fontWeight: '600' }, infoCard: { borderRadius: 13, backgroundColor: '#ECFDF5', padding: 12, marginTop: 10, flexDirection: 'row', gap: 8 }, infoText: { flex: 1, color: '#0F766E', fontSize: 10, lineHeight: 15 },
  problemCard: { margin: 14, borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#FECACA', overflow: 'hidden' }, problemHeader: { minHeight: 72, padding: 14, flexDirection: 'row', alignItems: 'center', gap: 8 }, problemTitle: { color: '#991B1B', fontSize: 13, fontWeight: '600' }, problemText: { color: '#7F1D1D', fontSize: 10, marginTop: 4 }, problemLink: { color: '#B91C1C', fontSize: 11, fontWeight: '600' }, problemBody: { borderTopWidth: 1, borderTopColor: '#FECACA', padding: 14 }, problemTypes: { gap: 8, paddingBottom: 2 }, problemChip: { minHeight: 36, borderRadius: 11, backgroundColor: '#FEF2F2', paddingHorizontal: 11, justifyContent: 'center' }, problemChipActive: { backgroundColor: '#B91C1C' }, problemChipText: { color: '#991B1B', fontSize: 9, fontWeight: '600' }, problemChipTextActive: { color: '#FFFFFF' },
  evidenceActions: { flexDirection: 'row', gap: 8, marginTop: 8 }, evidenceButton: { flex: 1, minHeight: 44, borderRadius: 12, backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#99F6E4', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, evidenceText: { color: '#0F766E', fontSize: 11, fontWeight: '600' }, fileRow: { minHeight: 40, borderRadius: 10, backgroundColor: '#F8FAFC', marginTop: 8, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center' }, fileName: { flex: 1, color: '#334155', fontSize: 10 }, remove: { color: '#B91C1C', fontSize: 10, fontWeight: '600' }, dangerButton: { minHeight: 49, borderRadius: 13, backgroundColor: '#B91C1C', marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 },
  state: { minHeight: 480, alignItems: 'center', justifyContent: 'center', padding: 28 }, stateTitle: { color: '#0F172A', fontSize: 19, fontWeight: '600', marginTop: 12 }, stateText: { color: '#64748B', fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 6 },
});
