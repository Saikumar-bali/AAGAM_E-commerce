...
const styles = StyleSheet.create({
  ...
  formCard: { marginTop: 10, borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 14 }, formTitle: { color: '#0F172A', fontSize: 16, fontWeight: '600' }, categories: { gap: 8, paddingVertical: 11 }, category: { minHeight: 36, borderRadius: 11, backgroundColor: '#F1F5F9', paddingHorizontal: 11, justifyContent: 'center' }, categoryActive: { backgroundColor: '#0F766E' }, categoryText: { color: '#475569', fontSize: 9, fontWeight: '600' }, categoryTextActive: { color: '#FFFFFF' },
  input: { minHeight: 50, borderRadius: 13, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#F8FAFC', paddingHorizontal: 12, color: '#0F172A', marginTop: 8 }, multiline: { minHeight: 115, paddingTop: 12, textAlignVertical: 'top' },
  evidenceActions: { flexDirection: 'row', gap: 8, marginTop: 8 }, evidenceButton: { flex: 1, minHeight: 44, borderRadius: 12, backgroundColor: '#ECFDF5', borderWidth: 1, borderColor: '#99F6E4', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, evidenceText: { color: '#0F766E', fontSize: 11, fontWeight: '600' }, fileRow: { minHeight: 42, borderRadius: 10, backgroundColor: '#F8FAFC', marginTop: 8, paddingHorizontal: 11, flexDirection: 'row', alignItems: 'center' }, fileName: { flex: 1, color: '#334155', fontSize: 10 }, removeText: { color: '#B91C1C', fontSize: 10, fontWeight: '600' },
  submit: { minHeight: 49, borderRadius: 13, backgroundColor: '#0F172A', marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, submitText: { color: '#FFFFFF', fontWeight: '600' },
  sectionTitle: { color: '#0F172A', fontSize: 17, fontWeight: '600', marginTop: 18, marginBottom: 8 }, ticketCard: { minHeight: 82, borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 12, marginBottom: 8, flexDirection: 'row', alignItems: 'center', gap: 10 }, ticketIcon: { width: 43, height: 43, borderRadius: 13, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' }, ticketIconClosed: { backgroundColor: '#E2E8F0' }, ticketSubject: { color: '#0F172A', fontSize: 12, fontWeight: '600' }, ticketMeta: { color: '#64748B', fontSize: 9, lineHeight: 14, marginTop: 4 }, jobLink: { color: '#0F766E', fontSize: 9, fontWeight: '600', marginTop: 4 },
