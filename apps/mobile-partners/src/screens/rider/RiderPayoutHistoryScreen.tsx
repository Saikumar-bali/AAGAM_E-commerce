...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#F8FAFC' }, flex: { flex: 1 }, header: { backgroundColor: '#0F766E', paddingHorizontal: 16, paddingBottom: 18, flexDirection: 'row', alignItems: 'center', gap: 12 }, headerButton: { width: 44, height: 44, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.14)', alignItems: 'center', justifyContent: 'center' }, eyebrow: { color: '#A7F3D0', fontSize: 9, fontWeight: '600', letterSpacing: 1 }, title: { color: '#FFFFFF', fontSize: 24, fontWeight: '600' },
  content: { padding: 14 }, heroCard: { borderRadius: 20, backgroundColor: '#0F172A', padding: 18, flexDirection: 'row', alignItems: 'center', gap: 13 }, heroIcon: { width: 54, height: 54, borderRadius: 17, backgroundColor: '#059669', alignItems: 'center', justifyContent: 'center' }, heroLabel: { color: '#A7F3D0', fontSize: 10, fontWeight: '600' }, heroAmount: { color: '#FFFFFF', fontSize: 27, fontWeight: '600', marginTop: 4 }, heroMeta: { color: '#CBD5E1', fontSize: 10, marginTop: 4 },
  rangeCard: { marginTop: 10, marginBottom: 11, borderRadius: 15, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 10, flexDirection: 'row', alignItems: 'center', gap: 8 }, rangeButton: { flex: 1, minHeight: 36, borderRadius: 10, backgroundColor: '#F1F5F9', alignItems: 'center', justifyContent: 'center' }, rangeButtonActive: { backgroundColor: '#CCFBF1' }, rangeText: { color: '#64748B', fontSize: 10, fontWeight: '600' }, rangeTextActive: { color: '#0F766E' },
  card: { borderRadius: 17, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 14, marginBottom: 8 }, cardHeader: { flexDirection: 'row', alignItems: 'center' }, type: { color: '#0F172A', fontSize: 13, fontWeight: '600' }, reference: { color: '#64748B', fontSize: 10, marginTop: 4 }, amount: { color: '#0F766E', fontSize: 17, fontWeight: '600' }, negative: { color: '#B91C1C' }, fact: { paddingVertical: 8, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#E2E8F0', marginTop: 8 }, factLabel: { color: '#64748B', fontSize: 9, fontWeight: '600' }, factValue: { color: '#0F172A', fontSize: 11, fontWeight: '500', marginTop: 4 },
  state: { minHeight: 300, alignItems: 'center', justifyContent: 'center', padding: 28 }, stateTitle: { color: '#0F172A', fontSize: 18, fontWeight: '600', marginTop: 10 }, stateText: { color: '#64748B', fontSize: 12, lineHeight: 18, textAlign: 'center', marginTop: 6 },
});
