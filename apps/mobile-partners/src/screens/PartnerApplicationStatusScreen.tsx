...
export function PartnerApplicationStatusScreen({ navigation }: any) {
  ...
  const editProfile = () => {
    ...
    Alert.alert(
      ...
      "Editing resets the application to draft. You'll need to resubmit.",
      [
...
const styles = StyleSheet.create({
  refresh: { width: 42, height: 42, borderRadius: 14, backgroundColor: '#fff', borderWidth: 1, borderColor: '#E2E8F0', alignItems: 'center', justifyContent: 'center' }, hero: { borderRadius: 26, backgroundColor: palette.ink, padding: 20, gap: 12 }, heroTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, version: { color: '#94A3B8', fontSize: 10, fontWeight: '600' }, heroTitle: { color: '#fff', fontSize: 22, fontWeight: '600' }, heroText: { color: '#CBD5E1', fontSize: 13, fontWeight: '600' }, liveNote: { color: '#94A3B8', fontSize: 10, fontWeight: '500' }, progressRow: { minHeight: 44, flexDirection: 'row', gap: 12 }, progressRail: { width: 18, alignItems: 'center' }, progressDot: { width: 13, height: 13, borderRadius: 7 }, progressLine: { width: 2, flex: 1, backgroundColor: '#E2E8F0' }, progressLabel: { flex: 1, color: '#334155', fontSize: 13, fontWeight: '600', paddingBottom: 16 }, warningRow: { flexDirection: 'row', gap: 12, borderRadius: 16, backgroundColor: '#FFFBEB', padding: 14 }, warningText: { color: '#92400E', fontSize: 12, lineHeight: 18, fontWeight: '500' }, fieldChip: { marginTop: 6, color: '#92400E', fontSize: 11, fontWeight: '600' }, successRow: { flexDirection: 'row', gap: 10, borderRadius: 16, backgroundColor: '#F0FDF4', padding: 14 }, successText: { flex: 1, color: '#166534', fontWeight: '600' }, waitingRow: { flexDirection: 'row', gap: 10, borderRadius: 16, backgroundColor: '#F0F9FF', padding: 14 }, waitingText: { flex: 1, color: '#075985', fontSize: 12, lineHeight: 18, fontWeight: '500' }, blocked: { color: '#B45309', fontSize: 11, textAlign: 'center', fontWeight: '500' }, rejected: { color: '#991B1B', backgroundColor: '#FEF2F2', borderRadius: 14, padding: 12, fontSize: 12, lineHeight: 18 }, empty: { color: '#64748B', fontSize: 12 }, eventRow: { flexDirection: 'row', gap: 12, paddingBottom: 16 }, timelineDot: { marginTop: 4, width: 10, height: 10, borderRadius: 5, backgroundColor: '#0F766E' }, eventType: { color: '#0F172A', fontSize: 11, fontWeight: '600' }, eventMessage: { color: '#475569', fontSize: 12, lineHeight: 18, marginTop: 4 }, eventDate: { color: '#94A3B8', fontSize: 9, marginTop: 4 }, referenceRow: { flexDirection: 'row', gap: 8, alignItems: 'center', borderRadius: 14, backgroundColor: '#F8FAFC', padding: 12 }, reference: { color: '#0F172A', fontSize: 12, fontWeight: '600' },
});
