...
const styles = StyleSheet.create({
  missing: { color: palette.amber, fontSize: 12, fontWeight: '600' },
  complete: { color: palette.green, fontSize: 12, fontWeight: '600' },
  ...
  requirementTitle: { color: palette.ink, fontSize: 14, fontWeight: '600', flex: 1 },
  required: { color: palette.red, fontSize: 9, fontWeight: '600', textTransform: 'uppercase' },
  optional: { color: palette.muted, fontSize: 9, fontWeight: '600', textTransform: 'uppercase' },
  ...
  uploadedName: { color: '#475569', fontSize: 10, fontWeight: '500', flex: 1 },
  notUploaded: { color: palette.amber, fontSize: 10, fontWeight: '600', marginTop: 8 },
  ...
  sourceTitle: { color: palette.ink, fontSize: 13, fontWeight: '600', marginTop: 8 },
  sourceSubtitle: { color: palette.muted, fontSize: 10, fontWeight: '500', marginTop: 4 },
  selected: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: '#F8FAFC', borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', padding: 12 },
  ...
  selectedName: { color: palette.ink, fontSize: 12, fontWeight: '600' },
  ...
  uploadProgressText: { color: palette.teal, fontSize: 11, fontWeight: '600', textAlign: 'center' },
  documentCard: { flexDirection: 'row', alignItems: 'flex-start', gap: 12, borderRadius: 17, borderWidth: 1, borderColor: '#E2E8F0', padding: 14 },
  documentType: { color: palette.ink, fontSize: 13, fontWeight: '600' },
  documentName: { color: palette.muted, fontSize: 11, marginTop: 4 },
  reviewNote: { color: palette.red, fontSize: 11, lineHeight: 16, marginTop: 8 },
