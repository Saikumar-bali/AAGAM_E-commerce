...
export function RiderApplicationScreen({ navigation }: any) {
  ...
  const useLocation = () => Geolocation.getCurrentPosition(
    (position) => { set('latitude', String(position.coords.latitude)); set('longitude', String(position.coords.longitude)); Alert.alert('Location added', 'Current coordinates were added.'); },
