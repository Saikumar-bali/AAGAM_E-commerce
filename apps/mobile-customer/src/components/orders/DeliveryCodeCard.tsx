...
const styles = StyleSheet.create({
  ...
  headingCopy: { flex: 1 },
  title: { color: '#134E4A', fontSize: 17, fontWeight: '600' },
  subtitle: { marginTop: 4, color: '#0F766E', fontSize: 12, lineHeight: 17, fontWeight: '500' },
  syncText: { marginTop: 12, color: '#64748B', fontSize: 11, fontWeight: '500' },
  ...
  code: { color: '#0F172A', fontSize: 34, fontWeight: '600', letterSpacing: 3 },
  expiry: { marginTop: 8, color: '#B45309', fontSize: 12, fontWeight: '600' },
  ...
  error: { marginTop: 12, color: '#B91C1C', fontSize: 12, lineHeight: 18, fontWeight: '600' },
});
