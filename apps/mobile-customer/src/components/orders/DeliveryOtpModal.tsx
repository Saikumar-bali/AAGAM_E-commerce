...
const styles = StyleSheet.create({
  ...
  eyebrow: { marginTop: 14, color: '#0F766E', fontSize: 10, fontWeight: '600', letterSpacing: 1.2 },
  title: { marginTop: 6, color: '#0F172A', fontSize: 23, fontWeight: '600', textAlign: 'center' },
  ...
  code: { marginTop: 8, color: '#0F172A', fontSize: 36, fontWeight: '600', letterSpacing: 3 },
  expiry: { marginTop: 8, color: '#92400E', fontSize: 12, fontWeight: '600' },
  ...
  error: { color: '#B91C1C', fontSize: 12, lineHeight: 18, fontWeight: '600', textAlign: 'center' },
  ...
  refreshText: { color: '#0F766E', fontSize: 13, fontWeight: '600' },
