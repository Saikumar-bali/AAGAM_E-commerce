...
const styles = StyleSheet.create({
  ...
  badge: { overflow: 'hidden', borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.18)', color: '#FFFFFF', paddingHorizontal: 10, paddingVertical: 4, fontSize: 10, fontWeight: '600', textTransform: 'uppercase' },
  title: { marginTop: 12, fontSize: 28, lineHeight: 32, fontWeight: '600', letterSpacing: -0.6 },
  titleCompact: { fontSize: 21, lineHeight: 25 },
  subtitle: { marginTop: 8, fontSize: 13, lineHeight: 18, fontWeight: '500', opacity: 0.9 },
  cta: { marginTop: 16, flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 12, paddingHorizontal: 12, paddingVertical: 8 },
  ctaText: { color: '#0F172A', fontSize: 12, fontWeight: '600' },
  ...
  emptyTitle: { marginTop: 10, color: '#0F172A', fontSize: 20, lineHeight: 25, fontWeight: '600', textAlign: 'center' },
