...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#F1F5F9' }, header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 24, paddingTop: 54, paddingBottom: 14 }, back: { padding: 9, borderRadius: 12, backgroundColor: '#fff', marginRight: 14 }, headerTitle: { fontSize: 20, fontWeight: '600', color: '#0F172A' }, content: { padding: 22 },
  hero: { alignItems: 'center', marginBottom: 24 }, icon: { width: 66, height: 66, borderRadius: 22, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' }, title: { marginTop: 14, fontSize: 25, fontWeight: '600', color: '#0F172A' }, subtitle: { marginTop: 8, color: '#64748B', fontSize: 13, lineHeight: 19, textAlign: 'center', fontWeight: '500' },
  card: { backgroundColor: '#fff', borderRadius: 26, padding: 20, gap: 14, elevation: 3 }, field: { minHeight: 56, borderRadius: 15, borderWidth: 1, borderColor: '#E2E8F0', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 14 }, input: { flex: 1, marginLeft: 10, fontSize: 15, color: '#0F172A' }, primary: { minHeight: 56, borderRadius: 16, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center' }, primaryText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  verifyIcon: { alignSelf: 'center', width: 48, height: 48, borderRadius: 16, backgroundColor: '#F0FDFA', alignItems: 'center', justifyContent: 'center' }, sent: { textAlign: 'center', color: '#475569', fontWeight: '600' }, otpRow: { flexDirection: 'row', gap: 6, justifyContent: 'space-between' }, otpCell: { flex: 1, height: 54, borderRadius: 13, borderWidth: 1.5, borderColor: '#CBD5E1', alignItems: 'center', justifyContent: 'center' }, otpActive: { borderColor: '#14B8A6', backgroundColor: '#F0FDFA' }, otpDigit: { fontSize: 22, fontWeight: '600', color: '#0F172A' }, hidden: { position: 'absolute', width: 1, height: 1, opacity: 0 }, link: { textAlign: 'center', color: '#0F766E', fontWeight: '600' }, linkDisabled: { color: '#94A3B8' }, secondaryLink: { textAlign: 'center', color: '#64748B', fontWeight: '600' },
  security: { marginTop: 18, borderRadius: 15, backgroundColor: '#F0FDF4', padding: 12, flexDirection: 'row', gap: 8 }, securityText: { flex: 1, color: '#166534', fontSize: 11, lineHeight: 17, fontWeight: '500' }, footer: { flexDirection: 'row', justifyContent: 'center', marginTop: 22, marginBottom: 36 }, footerText: { color: '#64748B' }, loginText: { color: '#0F766E', fontWeight: '600' },
});
