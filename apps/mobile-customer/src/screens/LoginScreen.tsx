        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.card}>
            ...
            {mode === 'PHONE' ? !masked ? <>
              ...
              <View style={styles.inputWrapper}><View style={styles.countryCode}><Text style={styles.countryCodeText}>+91</Text></View><TextInput testID="customer_phone_input" style={styles.input} value={phone} onChangeText={(value) => setPhone(digitsOnly(value))} placeholder="10-digit mobile number" keyboardType="number-pad" autoComplete="tel" textContentType="telephoneNumber" maxLength={10} placeholderTextColor="#94A3B8" /></View>
