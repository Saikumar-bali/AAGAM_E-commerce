...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#0F172A', fontSize: 19, fontWeight: '600' },
  ...
  title: { color: '#0F172A', fontSize: 27, fontWeight: '600', textAlign: 'center', marginTop: 16 },
  subtitle: { color: '#64748B', fontSize: 13, lineHeight: 20, fontWeight: '500', textAlign: 'center', marginTop: 8, marginBottom: 22 },
  card: { backgroundColor: '#FFFFFF', borderRadius: 25, borderWidth: 1, borderColor: '#E2E8F0', padding: 20, gap: 12, elevation: 4 },
  label: { color: '#334155', fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.6, marginTop: 4 },
  ...
  codeInput: { textAlign: 'center', fontSize: 22, fontWeight: '600', letterSpacing: 8 },
  ...
  link: { color: '#0F766E', fontWeight: '600', textAlign: 'center', paddingVertical: 4 },
  linkDisabled: { color: '#94A3B8' },
  success: { borderRadius: 15, backgroundColor: '#F0FDF4', padding: 14, flexDirection: 'row', alignItems: 'center', gap: 8 },
  successText: { flex: 1, color: '#166534', fontWeight: '600' },
});
