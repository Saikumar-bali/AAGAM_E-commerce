...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: '#0F766E', fontSize: 11, fontWeight: '600', letterSpacing: 1.8 },
  heading: { marginTop: 8, color: '#0F172A', fontSize: 30, fontWeight: '600', letterSpacing: -0.8 },
  lead: { marginTop: 4, color: '#64748B', fontSize: 13, lineHeight: 19, fontWeight: '600' },
  section: { marginTop: 26 },
  sectionTitleRow: { marginBottom: 12, flexDirection: 'row', alignItems: 'center', gap: 8 },
  sectionTitle: { color: '#0F172A', fontSize: 15, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.5 },
  errorCard: { marginTop: 18, padding: 16, borderRadius: 16, backgroundColor: '#FEF2F2', borderWidth: 1, borderColor: '#FECACA' },
  errorText: { color: '#B91C1C', fontWeight: '600' },
  retry: { marginTop: 8, color: '#0F766E', fontWeight: '600' },
  ...
  emptyTitle: { marginTop: 8, color: '#0F172A', fontSize: 17, fontWeight: '600' },
  emptyText: { marginTop: 4, color: '#64748B', fontSize: 12, lineHeight: 17, textAlign: 'center' },
  couponCard: { marginBottom: 12, borderRadius: 20, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', padding: 16 },
  couponDisabled: { opacity: 0.62 },
  couponTop: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  iconBox: { width: 42, height: 42, borderRadius: 14, justifyContent: 'center', alignItems: 'center', backgroundColor: '#CCFBF1' },
  couponCopy: { flex: 1 },
  couponValue: { color: '#0F172A', fontSize: 17, fontWeight: '600' },
  couponName: { marginTop: 2, color: '#64748B', fontSize: 12, fontWeight: '500' },
  code: { overflow: 'hidden', borderRadius: 10, borderWidth: 1, borderStyle: 'dashed', borderColor: '#94A3B8', paddingHorizontal: 8, paddingVertical: 8, color: '#0F172A', fontSize: 11, fontWeight: '600' },
  auto: { overflow: 'hidden', borderRadius: 999, backgroundColor: '#EDE9FE', paddingHorizontal: 8, paddingVertical: 4, color: '#6D28D9', fontSize: 10, fontWeight: '600' },
  ...
  meta: { color: '#64748B', fontSize: 11, fontWeight: '500' },
  ineligible: { marginTop: 12, color: '#B45309', fontSize: 12, fontWeight: '600' },
  useButton: { marginTop: 16, alignItems: 'center', borderRadius: 13, backgroundColor: '#0F172A', paddingVertical: 12 },
  useButtonText: { color: '#FFFFFF', fontWeight: '600' },
  autoMessage: { marginTop: 12, color: '#0F766E', fontSize: 12, fontWeight: '600' },
});
