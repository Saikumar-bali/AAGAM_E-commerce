...
const styles = StyleSheet.create({
  ...
  errorBanner: { marginHorizontal: 16, marginTop: 8, borderRadius: 16, borderWidth: 1, borderColor: '#FCD34D', backgroundColor: '#FFFBEB', padding: 13, flexDirection: 'row', alignItems: 'center', gap: 12 },
  errorCopy: { flex: 1 },
