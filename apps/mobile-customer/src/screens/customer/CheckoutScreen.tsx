...
export const CheckoutScreen = () => {
  ...
  // Locality fetch commented out — using Mapbox geocoding search
  // useEffect(() => {
  ...
  const useCurrentLocation = async () => {
    if (Platform.OS === 'android') {
      const result = await PermissionsAndroid.request(PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION, { title: 'Allow delivery location', message: 'Aagaam uses your location to set the delivery point.', buttonPositive: 'Allow', buttonNegative: 'Not now' });
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#F8FAFC' }, content: { padding: 16, paddingBottom: 150 }, centered: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 24, backgroundColor: '#F8FAFC' }, emptyTitle: { fontSize: 20, fontWeight: '600', color: '#0F172A' }, emptyText: { marginTop: 8, color: '#64748B' }, browseButton: { marginTop: 18, borderRadius: 14, backgroundColor: '#0F766E', paddingHorizontal: 18, paddingVertical: 12 }, browseButtonText: { color: '#FFFFFF', fontWeight: '600' }, sectionTitle: { marginTop: 12, marginBottom: 12, fontSize: 20, fontWeight: '600', color: '#0F172A' },
  checkoutHeader: { flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 8 }, backButton: { width: 44, height: 44, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0' }, checkoutTitle: { color: '#0F172A', fontSize: 22, fontWeight: '600' }, checkoutSubtitle: { marginTop: 2, color: '#64748B', fontSize: 12, fontWeight: '600' },
  addressCard: { backgroundColor: '#FFFFFF', borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', padding: 16, marginBottom: 12 }, addressCardActive: { borderColor: '#0F766E', backgroundColor: '#F0FDFA' }, addressLabel: { fontSize: 12, fontWeight: '600', color: '#0F766E', textTransform: 'uppercase' }, addressName: { marginTop: 6, fontSize: 16, fontWeight: '600', color: '#0F172A' }, addressText: { marginTop: 4, color: '#475569' }, addressPhone: { marginTop: 6, color: '#0F172A', fontWeight: '500' }, noticeCard: { borderRadius: 16, backgroundColor: '#FFF7ED', padding: 16, borderWidth: 1, borderColor: '#FED7AA' }, noticeTitle: { fontSize: 16, fontWeight: '600', color: '#9A3412' }, noticeText: { marginTop: 6, color: '#9A3412' }, inlineAddressButton: { marginTop: 12, alignItems: 'center', borderRadius: 14, backgroundColor: '#9A3412', paddingVertical: 12 }, inlineAddressButtonText: { color: '#FFFFFF', fontWeight: '600' }, addAnotherButton: { alignSelf: 'flex-start', paddingVertical: 8 }, addAnotherText: { color: '#0F766E', fontWeight: '600' }, addressForm: { marginBottom: 16, borderRadius: 20, borderWidth: 1, borderColor: '#99F6E4', backgroundColor: '#F0FDFA', padding: 12, gap: 12 }, addressFormError: { borderColor: '#FCA5A5', backgroundColor: '#FEF2F2' }, addressFormTitle: { fontSize: 17, fontWeight: '600', color: '#134E4A' }, locationButton: { alignItems: 'center', borderRadius: 14, backgroundColor: '#0F766E', paddingVertical: 12 }, locationButtonText: { color: '#FFFFFF', fontWeight: '600' }, addressInput: { borderRadius: 13, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#FFFFFF', paddingHorizontal: 12, paddingVertical: 12, color: '#0F172A' }, addressInputError: { borderColor: '#EF4444', backgroundColor: '#FEF2F2' }, addressErrorText: { marginTop: 4, color: '#B91C1C', fontSize: 11, lineHeight: 16, fontWeight: '600' }, saveAddressButton: { alignItems: 'center', borderRadius: 14, backgroundColor: '#0F766E', paddingVertical: 16 }, saveAddressText: { color: '#FFFFFF', fontWeight: '600' },
  paymentRow: { gap: 12 }, paymentButton: { borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 16 }, paymentButtonActive: { borderColor: '#0F766E', backgroundColor: '#F0FDFA' }, paymentLabel: { fontSize: 15, fontWeight: '600', color: '#0F172A' }, paymentLabelActive: { color: '#115E59' }, paymentMeta: { marginTop: 6, color: '#64748B', fontSize: 12 }, couponHeadingRow: { marginTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, viewDeals: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingVertical: 8 }, viewDealsText: { color: '#0F766E', fontSize: 12, fontWeight: '600' }, couponRow: { flexDirection: 'row', gap: 12 }, couponInput: { flex: 1, borderRadius: 15, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#FFFFFF', paddingHorizontal: 16, color: '#0F172A', fontWeight: '600' }, applyButton: { justifyContent: 'center', borderRadius: 15, backgroundColor: '#0F172A', paddingHorizontal: 18 }, applyButtonText: { color: '#FFFFFF', fontWeight: '600' }, couponError: { marginTop: 8, color: '#B91C1C', fontSize: 12, fontWeight: '600' }, appliedCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 16, borderWidth: 1, borderColor: '#99F6E4', backgroundColor: '#F0FDFA', padding: 16 }, appliedCopy: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 12 }, appliedTextWrap: { flex: 1 }, appliedTitle: { color: '#115E59', fontSize: 14, fontWeight: '600' }, appliedText: { marginTop: 4, color: '#0F766E', fontSize: 12, fontWeight: '500' }, autoBadge: { overflow: 'hidden', borderRadius: 999, backgroundColor: '#EDE9FE', paddingHorizontal: 8, paddingVertical: 4, color: '#6D28D9', fontSize: 10, fontWeight: '600' },
  summaryCard: { borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 16 }, freeDeliveryCard: { marginBottom: 16, borderRadius: 14, borderWidth: 1, borderColor: '#FDE68A', backgroundColor: '#FFFBEB', padding: 12 }, freeDeliveryUnlocked: { borderColor: '#A7F3D0', backgroundColor: '#ECFDF5' }, freeDeliveryTitle: { color: '#065F46', fontWeight: '600', fontSize: 13 }, freeDeliveryText: { marginTop: 4, color: '#64748B', fontSize: 11, fontWeight: '500' }, freeDeliveryValue: { color: '#059669', fontWeight: '600' }, summaryRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12, gap: 12 }, summaryText: { color: '#475569', flex: 1 }, summaryAmount: { color: '#334155', fontWeight: '500' }, summaryDivider: { height: 1, backgroundColor: '#E2E8F0', marginVertical: 8 }, discountLabel: { color: '#0F766E', fontWeight: '600' }, discountValue: { color: '#0F766E', fontWeight: '600' }, totalLabel: { fontSize: 17, fontWeight: '600', color: '#0F172A' }, totalValue: { fontSize: 17, fontWeight: '600', color: '#0F172A' }, errorText: { marginTop: 12, color: '#B91C1C', fontWeight: '500' },   placeOrderButton: { marginTop: 20, borderRadius: 16, backgroundColor: '#0F766E', paddingVertical: 16, alignItems: 'center' }, placeOrderButtonDisabled: { backgroundColor: '#94A3B8' }, placeOrderText: { color: '#FFFFFF', fontSize: 16, fontWeight: '600' },
