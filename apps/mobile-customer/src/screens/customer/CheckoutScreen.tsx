...
const styles = StyleSheet.create({
  ...
  addressCard: { backgroundColor: '#FFFFFF', borderRadius: 18, borderWidth: 1, borderColor: '#E2E8F0', padding: 16, marginBottom: 12 }, addressCardActive: { borderColor: '#0F766E', backgroundColor: '#F0FDFA' }, addressLabel: { fontSize: 12, fontWeight: '600', color: '#0F766E', textTransform: 'uppercase' }, addressName: { marginTop: 6, fontSize: 16, fontWeight: '600', color: '#0F172A' }, addressText: { marginTop: 4, color: '#475569' }, addressPhone: { marginTop: 6, color: '#0F172A', fontWeight: '500' }, noticeCard: { borderRadius: 18, backgroundColor: '#FFF7ED', padding: 16, borderWidth: 1, borderColor: '#FED7AA' }, noticeTitle: { fontSize: 16, fontWeight: '600', color: '#9A3412' }, noticeText: { marginTop: 6, color: '#9A3412' }, inlineAddressButton: { marginTop: 12, alignItems: 'center', borderRadius: 14, backgroundColor: '#9A3412', paddingVertical: 12 }, inlineAddressButtonText: { color: '#FFFFFF', fontWeight: '600' }, addAnotherButton: { alignSelf: 'flex-start', paddingVertical: 8 }, addAnotherText: { color: '#0F766E', fontWeight: '600' }, addressForm: { marginBottom: 16, borderRadius: 20, borderWidth: 1, borderColor: '#99F6E4', backgroundColor: '#F0FDFA', padding: 12, gap: 10 }, addressFormError: { borderColor: '#FCA5A5', backgroundColor: '#FEF2F2' }, addressFormTitle: { fontSize: 17, fontWeight: '600', color: '#134E4A' }, locationButton: { alignItems: 'center', borderRadius: 14, backgroundColor: '#0F766E', paddingVertical: 12 }, locationButtonText: { color: '#FFFFFF', fontWeight: '600' }, addressInput: { borderRadius: 13, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#FFFFFF', paddingHorizontal: 12, paddingVertical: 11, color: '#0F172A' }, addressInputError: { borderColor: '#EF4444', backgroundColor: '#FEF2F2' }, addressErrorText: { marginTop: 4, color: '#B91C1C', fontSize: 11, lineHeight: 16, fontWeight: '600' }, saveAddressButton: { alignItems: 'center', borderRadius: 14, backgroundColor: '#0F766E', paddingVertical: 14 }, saveAddressText: { color: '#FFFFFF', fontWeight: '600' },
  paymentRow: { gap: 10 }, paymentButton: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 16 }, paymentButtonActive: { borderColor: '#0F766E', backgroundColor: '#F0FDFA' }, paymentLabel: { fontSize: 15, fontWeight: '600', color: '#0F172A' }, paymentLabelActive: { color: '#115E59' }, paymentMeta: { marginTop: 6, color: '#64748B', fontSize: 12 }, couponHeadingRow: { marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, viewDeals: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingVertical: 8 }, viewDealsText: { color: '#0F766E', fontSize: 12, fontWeight: '600' }, couponRow: { flexDirection: 'row', gap: 10 }, couponInput: { flex: 1, borderRadius: 15, borderWidth: 1, borderColor: '#CBD5E1', backgroundColor: '#FFFFFF', paddingHorizontal: 14, color: '#0F172A', fontWeight: '600' }, applyButton: { justifyContent: 'center', borderRadius: 15, backgroundColor: '#0F172A', paddingHorizontal: 18 }, applyButtonText: { color: '#FFFFFF', fontWeight: '600' }, couponError: { marginTop: 8, color: '#B91C1C', fontSize: 12, fontWeight: '600' }, appliedCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 18, borderWidth: 1, borderColor: '#99F6E4', backgroundColor: '#F0FDFA', padding: 16 }, appliedCopy: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 12 }, appliedTextWrap: { flex: 1 }, appliedTitle: { color: '#115E59', fontSize: 14, fontWeight: '600' }, appliedText: { marginTop: 4, color: '#0F766E', fontSize: 12, fontWeight: '500' }, autoBadge: { overflow: 'hidden', borderRadius: 999, backgroundColor: '#EDE9FE', paddingHorizontal: 8, paddingVertical: 4, color: '#6D28D9', fontSize: 10, fontWeight: '600' },
  summaryCard: { borderRadius: 18, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 16 }, freeDeliveryCard: { marginBottom: 15, borderRadius: 14, borderWidth: 1, borderColor: '#FDE68A', backgroundColor: '#FFFBEB', padding: 12 }, freeDeliveryUnlocked: { borderColor: '#A7F3D0', backgroundColor: '#ECFDF5' }, freeDeliveryTitle: { color: '#065F46', fontWeight: '600', fontSize: 13 }, freeDeliveryText: { marginTop: 4, color: '#64748B', fontSize: 11, fontWeight: '500' }, freeDeliveryValue: { color: '#059669', fontWeight: '600' }, summaryRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10, gap: 12 }, summaryText: { color: '#475569', flex: 1 }, summaryAmount: { color: '#334155', fontWeight: '500' }, summaryDivider: { height: 1, backgroundColor: '#E2E8F0', marginVertical: 8 }, discountLabel: { color: '#0F766E', fontWeight: '600' }, discountValue: { color: '#0F766E', fontWeight: '600' }, totalLabel: { fontSize: 17, fontWeight: '600', color: '#0F172A' }, totalValue: { fontSize: 17, fontWeight: '600', color: '#0F172A' }, errorText: { marginTop: 10, color: '#B91C1C', fontWeight: '500' },   placeOrderButton: { marginTop: 20, borderRadius: 18, backgroundColor: '#0F766E', paddingVertical: 16, alignItems: 'center' }, placeOrderButtonDisabled: { backgroundColor: '#94A3B8' }, placeOrderText: { color: '#FFFFFF', fontSize: 16, fontWeight: '600' },
