...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#F4F7FB' }, content: { padding: 16, paddingBottom: 150 }, centered: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#F4F7FB', padding: 28, gap: 12 }, loadingText: { color: '#64748B', fontWeight: '500' },
  errorIcon: { width: 58, height: 58, borderRadius: 20, backgroundColor: '#FEE2E2', alignItems: 'center', justifyContent: 'center' }, errorTitle: { color: '#0F172A', fontSize: 20, fontWeight: '600', textAlign: 'center' }, errorText: { color: '#64748B', fontSize: 12, lineHeight: 18, fontWeight: '600', textAlign: 'center' }, retryButton: { marginTop: 4, minHeight: 48, borderRadius: 15, backgroundColor: '#0F766E', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, paddingHorizontal: 24 }, retryText: { color: '#FFFFFF', fontWeight: '600' },
  hero: { borderRadius: 28, backgroundColor: '#0F172A', padding: 20, shadowColor: '#0F172A', shadowOffset: { width: 0, height: 12 }, shadowOpacity: 0.18, shadowRadius: 22, elevation: 7 }, heroIcon: { width: 52, height: 52, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(20,184,166,0.22)' }, kicker: { marginTop: 16, color: '#5EEAD4', fontSize: 10, fontWeight: '600', letterSpacing: 1.4 }, title: { marginTop: 8, color: '#FFFFFF', fontSize: 30, lineHeight: 35, fontWeight: '600', letterSpacing: -0.9 }, subtitle: { marginTop: 8, color: '#CBD5E1', fontSize: 13, lineHeight: 20, fontWeight: '600' }, secureRow: { marginTop: 16, flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 14, backgroundColor: 'rgba(255,255,255,0.08)', padding: 12 }, secureText: { flex: 1, color: '#E2E8F0', fontSize: 11, lineHeight: 16, fontWeight: '500' },
  emptyCard: { marginTop: 16, borderRadius: 24, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 28, alignItems: 'center' }, emptyTitle: { marginTop: 12, color: '#0F172A', fontSize: 18, fontWeight: '600', textAlign: 'center' }, emptyText: { marginTop: 8, color: '#64748B', fontSize: 12, lineHeight: 18, fontWeight: '600', textAlign: 'center' },
  sectionCard: { marginTop: 16, borderRadius: 24, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', padding: 16 }, step: { color: '#0F766E', fontSize: 10, fontWeight: '600', letterSpacing: 1.2 }, sectionTitle: { marginTop: 4, color: '#0F172A', fontSize: 19, fontWeight: '600' }, orderList: { marginTop: 12, gap: 8 }, orderCard: { flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', padding: 16, backgroundColor: '#FFFFFF' }, orderCardSelected: { borderColor: '#14B8A6', backgroundColor: '#F0FDFA' }, orderTitle: { color: '#0F172A', fontSize: 14, fontWeight: '600' }, orderMeta: { marginTop: 4, color: '#64748B', fontSize: 11, fontWeight: '600' }, orderFooter: { marginTop: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, status: { borderRadius: 999, backgroundColor: '#F1F5F9', paddingHorizontal: 8, paddingVertical: 4, color: '#475569', fontSize: 9, fontWeight: '600' }, total: { color: '#0F172A', fontSize: 12, fontWeight: '600' },
  selectedOrder: { marginTop: 16, borderRadius: 15, borderWidth: 1, borderColor: '#99F6E4', backgroundColor: '#F0FDFA', padding: 12 }, selectedLabel: { color: '#0F766E', fontSize: 9, fontWeight: '600', letterSpacing: 0.8 }, selectedValue: { marginTop: 4, color: '#134E4A', fontSize: 13, fontWeight: '600' }, label: { marginTop: 16, marginBottom: 8, color: '#334155', fontSize: 11, fontWeight: '600', textTransform: 'uppercase', letterSpacing: 0.6 }, chipWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 }, chip: { borderRadius: 999, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#F8FAFC', paddingHorizontal: 12, paddingVertical: 8 }, chipActive: { borderColor: '#0F766E', backgroundColor: '#0F766E' }, chipText: { color: '#475569', fontSize: 11, fontWeight: '600' }, chipTextActive: { color: '#FFFFFF' },
  messageInput: { minHeight: 132, borderRadius: 16, borderWidth: 1.5, borderColor: '#E2E8F0', backgroundColor: '#F8FAFC', paddingHorizontal: 16, paddingVertical: 12, color: '#0F172A', fontSize: 13, lineHeight: 19 }, counter: { marginTop: 4, color: '#94A3B8', fontSize: 10, fontWeight: '500', textAlign: 'right' }, refundRow: { marginTop: 16, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#F8FAFC', padding: 12 }, refundTitle: { color: '#0F172A', fontSize: 12, fontWeight: '600' }, refundText: { marginTop: 4, color: '#64748B', fontSize: 10, lineHeight: 15, fontWeight: '600' }, submitButton: { marginTop: 16, minHeight: 56, borderRadius: 16, backgroundColor: '#0F766E', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, disabled: { opacity: 0.5 }, submitText: { color: '#FFFFFF', fontSize: 14, fontWeight: '600' },
  historyHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, noTickets: { marginTop: 12, borderRadius: 15, backgroundColor: '#F8FAFC', padding: 12, color: '#64748B', fontSize: 11, lineHeight: 17, fontWeight: '500' }, ticketCard: { marginTop: 12, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', padding: 12 }, ticketHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8 }, openBadge: { flexDirection: 'row', alignItems: 'center', gap: 4 }, openBadgeText: { color: '#047857', fontSize: 9, fontWeight: '600', letterSpacing: 0.7 }, ticketDate: { color: '#94A3B8', fontSize: 9, fontWeight: '600' }, ticketCategory: { marginTop: 8, color: '#0F172A', fontSize: 12, fontWeight: '600' }, ticketMessage: { marginTop: 4, color: '#64748B', fontSize: 11, lineHeight: 17, fontWeight: '600' },
});
