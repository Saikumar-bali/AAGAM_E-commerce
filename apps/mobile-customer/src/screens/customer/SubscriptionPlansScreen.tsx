...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#F4F8F6' }, header: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 18, paddingVertical: 14, gap: 12, backgroundColor: '#FFFFFF', borderBottomWidth: 1, borderBottomColor: '#E3ECE7' }, iconButton: { width: 44, height: 44, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: '#EFF7F3' }, headerCopy: { flex: 1 }, eyebrow: { fontSize: 10, fontWeight: '600', letterSpacing: 1.2, color: '#0F766E' }, title: { fontSize: 24, fontWeight: '600', color: '#123D32' }, myButton: { minHeight: 44, paddingHorizontal: 14, borderRadius: 15, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#A9D4C3' }, myButtonText: { color: '#0F766E', fontWeight: '600' }, hero: { margin: 16, padding: 18, borderRadius: 24, backgroundColor: '#0F766E', flexDirection: 'row', gap: 14, alignItems: 'center' }, heroIcon: { width: 56, height: 56, borderRadius: 18, backgroundColor: 'rgba(255,255,255,0.16)', alignItems: 'center', justifyContent: 'center' }, heroCopy: { flex: 1 }, heroTitle: { color: '#FFFFFF', fontSize: 18, fontWeight: '600' }, heroText: { color: '#D8F6E9', fontSize: 12, lineHeight: 18, marginTop: 4 }, list: { paddingHorizontal: 16, paddingBottom: 36, gap: 14 }, card: { backgroundColor: '#FFFFFF', borderRadius: 24, padding: 16, borderWidth: 1, borderColor: '#E2EBE6', shadowColor: '#0F3D2E', shadowOffset: { width: 0, height: 7 }, shadowOpacity: 0.08, shadowRadius: 14, elevation: 3 }, cardTop: { flexDirection: 'row', gap: 14 }, image: { width: 98, height: 98, borderRadius: 20, backgroundColor: '#E8F4EE' }, imageFallback: { alignItems: 'center', justifyContent: 'center' }, cardCopy: { flex: 1 }, badge: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 999, backgroundColor: '#E4F7ED' }, badgeText: { fontSize: 9, fontWeight: '600', color: '#0F766E', letterSpacing: .5 }, planName: { fontSize: 19, fontWeight: '600', color: '#142F28', marginTop: 8 }, description: { color: '#64746D', fontSize: 12, lineHeight: 17, marginTop: 4 }, itemStrip: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 14 }, itemChip: { borderRadius: 999, backgroundColor: '#F1F5F3', paddingHorizontal: 10, paddingVertical: 6 }, itemChipText: { color: '#39554B', fontSize: 11, fontWeight: '500' }, priceRow: { flexDirection: 'row', alignItems: 'baseline', gap: 8, marginTop: 15 }, price: { fontSize: 22, fontWeight: '600', color: '#123D32' }, mrp: { color: '#8A9993', textDecorationLine: 'line-through', fontWeight: '500' }, save: { color: '#D36A00', fontWeight: '600', fontSize: 12 }, factRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 6, marginTop: 12 }, factText: { color: '#516860', fontSize: 11, fontWeight: '500', marginRight: 4 }, cta: { minHeight: 50, backgroundColor: '#0F766E', borderRadius: 17, alignItems: 'center', justifyContent: 'center', marginTop: 16 }, ctaText: { color: '#FFFFFF', fontSize: 15, fontWeight: '600' }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 28, gap: 10 }, muted: { color: '#6B7D75', textAlign: 'center', lineHeight: 20 }, errorTitle: { color: '#203D33', fontSize: 18, fontWeight: '600', textAlign: 'center' }, retry: { minHeight: 46, paddingHorizontal: 24, borderRadius: 15, backgroundColor: '#0F766E', justifyContent: 'center' }, retryText: { color: '#FFFFFF', fontWeight: '600' },
});
