...
const styles = StyleSheet.create({
  ...
  button: { marginTop: 14, borderRadius: 16, backgroundColor: '#0F766E', paddingVertical: 16, alignItems: 'center' },
  supportButton: { marginTop: 14, borderRadius: 16, backgroundColor: '#0F172A', paddingVertical: 16, alignItems: 'center' },
