...
const styles = StyleSheet.create({
  ...
  headerBackText: { color: '#0F172A', fontSize: 34, lineHeight: 36, fontWeight: '500' },
  headerCopy: { flex: 1 },
  invalidState: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 28, backgroundColor: '#F8FAFC' },
  invalidTitle: { color: '#0F172A', fontSize: 22, fontWeight: '600' },
  invalidText: { marginTop: 8, color: '#64748B', lineHeight: 20, textAlign: 'center' },
  backButton: { marginTop: 18, borderRadius: 16, backgroundColor: '#0F766E', paddingHorizontal: 18, paddingVertical: 12 },
  ...
  card: { marginTop: 16, backgroundColor: '#FFFFFF', borderRadius: 20, padding: 16, borderWidth: 1, borderColor: '#E2E8F0' },
  ...
  input: { borderWidth: 1, borderColor: '#E2E8F0', borderRadius: 16, paddingHorizontal: 16, paddingVertical: 12, color: '#0F172A' },
  textArea: { minHeight: 90, textAlignVertical: 'top' },
  button: { marginTop: 16, borderRadius: 16, backgroundColor: '#0F766E', paddingVertical: 16, alignItems: 'center' },
  supportButton: { marginTop: 16, borderRadius: 16, backgroundColor: '#0F172A', paddingVertical: 16, alignItems: 'center' },
