...
const styles = StyleSheet.create({
  ...
  headerButton: { width: 52, height: 52, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' },
  headerCopy: { flex: 1 },
  title: { color: '#0F172A', fontSize: 23, fontWeight: '600', letterSpacing: -0.5 },
  subtitle: { marginTop: 4, color: '#64748B', fontSize: 13, fontWeight: '500' },
  addButton: { width: 52, height: 52, borderRadius: 16, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' },
  deliveringCard: { marginHorizontal: 16, marginBottom: 8, flexDirection: 'row', alignItems: 'center', borderRadius: 24, borderWidth: 1, borderColor: '#99F6E4', backgroundColor: '#F0FDFA', padding: 17, gap: 12 },
  locationCircle: { width: 54, height: 54, borderRadius: 28, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' },
  deliveringCopy: { flex: 1 }, deliveringLabel: { color: '#64748B', fontWeight: '500', fontSize: 12 }, deliveringTitle: { marginTop: 4, color: '#0F172A', fontSize: 16, fontWeight: '600' }, deliveringText: { marginTop: 4, color: '#64748B', fontWeight: '500' },
  list: { padding: 16, paddingBottom: 160 }, centered: { flex: 1, alignItems: 'center', justifyContent: 'center' },
  addressCard: { marginBottom: 16, borderRadius: 24, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', overflow: 'hidden' },
  addressBody: { flexDirection: 'row', alignItems: 'flex-start', padding: 16, gap: 12 }, addressIcon: { width: 58, height: 58, borderRadius: 16, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, addressCopy: { flex: 1 }, addressTitleRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 8 }, addressTitle: { color: '#0F172A', fontSize: 18, fontWeight: '600' }, defaultBadge: { color: '#0F766E', backgroundColor: '#E6FFFA', borderRadius: 999, paddingHorizontal: 8, paddingVertical: 4, fontSize: 10, fontWeight: '600' }, addressText: { marginTop: 4, color: '#64748B', fontSize: 13, lineHeight: 19, fontWeight: '600' }, phoneRow: { marginTop: 8, flexDirection: 'row', alignItems: 'center', gap: 6 }, phoneText: { color: '#475569', fontWeight: '500', fontSize: 12 },
  actions: { flexDirection: 'row', alignItems: 'center', borderTopWidth: 1, borderTopColor: '#F1F5F9', paddingHorizontal: 12, paddingVertical: 12, gap: 12 }, action: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, minHeight: 38 }, actionText: { color: '#0F766E', fontWeight: '600' }, deleteText: { color: '#DC2626' }, deliverButton: { minWidth: 126, alignItems: 'center', borderRadius: 999, borderWidth: 1.5, borderColor: '#0F766E', paddingHorizontal: 16, paddingVertical: 12 }, deliverButtonActive: { backgroundColor: '#0F766E' }, deliverText: { color: '#0F766E', fontWeight: '600' }, deliverTextActive: { color: '#FFFFFF' },
  empty: { marginTop: 18, alignItems: 'center', borderRadius: 24, borderWidth: 1.5, borderStyle: 'dashed', borderColor: '#99F6E4', backgroundColor: '#FFFFFF', padding: 28 }, emptyIcon: { width: 68, height: 68, borderRadius: 20, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, emptyTitle: { marginTop: 16, color: '#0F172A', fontSize: 18, fontWeight: '600' }, emptyText: { marginTop: 6, color: '#64748B', lineHeight: 20, textAlign: 'center', fontWeight: '600' }, errorState: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 28 }, errorTitle: { color: '#0F172A', fontSize: 18, fontWeight: '600', textAlign: 'center' }, errorText: { marginTop: 8, color: '#64748B', lineHeight: 20, textAlign: 'center', fontWeight: '600' }, errorBanner: { marginBottom: 12, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 14, backgroundColor: '#FFF7ED', padding: 12 }, errorBannerText: { flex: 1, color: '#9A3412', fontSize: 12, fontWeight: '500' }, errorRetry: { color: '#9A3412', fontSize: 12, fontWeight: '600' }, primaryButton: { marginTop: 18, flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 15, backgroundColor: '#0F766E', paddingHorizontal: 17, paddingVertical: 12 }, primaryButtonText: { color: '#FFFFFF', fontWeight: '600' },
});
