...
const styles = StyleSheet.create({
  ...
  galleryButton: { position: 'absolute', right: 18, bottom: 17, borderRadius: 15, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', paddingHorizontal: 16, paddingVertical: 11 },
  ...
  deliveryCard: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', columnGap: 8, rowGap: 4, borderRadius: 18, padding: 14, backgroundColor: '#F0FDFA' },
  ...
  benefitsCard: { marginHorizontal: 18, marginTop: 16, flexDirection: 'row', borderRadius: 17, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', paddingVertical: 14 },
  ...
  detailsCard: { marginHorizontal: 18, marginTop: 16, borderRadius: 18, borderWidth: 1, borderColor: '#E2E8F0', padding: 16, backgroundColor: '#FFFFFF' },
  ...
  nutritionCard: { marginHorizontal: 18, marginTop: 16, borderRadius: 18, borderWidth: 1, borderColor: '#E2E8F0', padding: 16, backgroundColor: '#FFFFFF' },
  nutritionTitle: { color: '#0F172A', fontSize: 13, fontWeight: '600' },
  nutritionUnit: { color: '#64748B', fontWeight: '600' },
  nutritionGrid: { marginTop: 14, flexDirection: 'row', justifyContent: 'space-between' },
  ...
  nutritionLink: { marginTop: 15, color: '#0F766E', fontSize: 11, fontWeight: '600' },
