...
export const ProductDetailScreen = () => {
  ...
  const productDescription = product.description || 'Product details will appear here when provided by the catalog.';
  const deliveryTitle = defaultAddress
...
const styles = StyleSheet.create({
  ...
  errorText: { color: '#0F172A', fontSize: 16, fontWeight: '600', textAlign: 'center' },
  backText: { marginTop: 12, color: '#0F766E', fontWeight: '600' },
  screen: { flex: 1, backgroundColor: '#F8FAFC' },
  topBar: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingTop: 14, paddingBottom: 10, backgroundColor: '#FFFFFF' },
  ...
  cartBadgeText: { color: '#FFFFFF', fontSize: 11, fontWeight: '600' },
  container: { flex: 1 },
  ...
  pagination: { position: 'absolute', bottom: 14, left: 0, right: 0, flexDirection: 'row', justifyContent: 'center', gap: 4 },
  paginationDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#CBD5E1' },
  paginationDotActive: { width: 20, backgroundColor: '#0F766E' },
  galleryButton: { position: 'absolute', right: 18, bottom: 17, borderRadius: 15, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', paddingHorizontal: 16, paddingVertical: 12 },
  galleryText: { color: '#0F172A', fontSize: 12, fontWeight: '600' },
  productHeader: { paddingHorizontal: 18, paddingTop: 18, gap: 12, backgroundColor: '#FFFFFF' },
  titleCopy: { gap: 6 },
  name: { color: '#0F172A', fontSize: 24, fontWeight: '600' },
  measure: { color: '#64748B', fontSize: 14, fontWeight: '500' },
  ratingRow: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', gap: 8 },
  rating: { color: '#0F766E', fontSize: 14, fontWeight: '600' },
  reviewText: { color: '#475569', fontSize: 12, fontWeight: '500' },
  qualityText: { color: '#334155', fontSize: 11, fontWeight: '500' },
  deliveryCard: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', columnGap: 8, rowGap: 4, borderRadius: 16, padding: 16, backgroundColor: '#F0FDFA' },
  deliveryLabel: { color: '#64748B', fontSize: 12, fontWeight: '500' },
  deliveryTitle: { width: '100%', paddingLeft: 31, color: '#0F766E', fontSize: 14, fontWeight: '600' },
  priceRow: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 18, paddingTop: 17, backgroundColor: '#FFFFFF' },
  price: { color: '#0F172A', fontSize: 28, fontWeight: '600' },
  mrp: { color: '#94A3B8', fontSize: 15, textDecorationLine: 'line-through', fontWeight: '500' },
  discount: { borderRadius: 999, paddingHorizontal: 8, paddingVertical: 6, color: '#0F766E', backgroundColor: '#CCFBF1', fontSize: 12, fontWeight: '600' },
  taxText: { paddingHorizontal: 18, paddingTop: 4, paddingBottom: 16, color: '#64748B', fontSize: 12, backgroundColor: '#FFFFFF' },
  benefitsCard: { marginHorizontal: 18, marginTop: 16, flexDirection: 'row', borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', paddingVertical: 16 },
  benefit: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 4, borderRightWidth: 1, borderRightColor: '#E2E8F0' },
  benefitText: { marginTop: 6, color: '#0F172A', textAlign: 'center', fontSize: 9, lineHeight: 12, fontWeight: '500' },
  sectionTitle: { marginTop: 18, paddingHorizontal: 18, color: '#0F172A', fontSize: 17, fontWeight: '600' },
  description: { paddingHorizontal: 18, paddingTop: 8, color: '#64748B', fontSize: 13, lineHeight: 20, fontWeight: '600' },
  detailsCard: { marginHorizontal: 18, marginTop: 16, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', padding: 16, backgroundColor: '#FFFFFF' },
  detailRow: { paddingVertical: 8, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' },
  detailLabel: { color: '#64748B', fontSize: 11, fontWeight: '600' },
  detailValue: { marginTop: 4, color: '#0F172A', fontSize: 13, lineHeight: 18, fontWeight: '500' },
  nutritionCard: { marginHorizontal: 18, marginTop: 16, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', padding: 16, backgroundColor: '#FFFFFF' },
  nutritionTitle: { color: '#0F172A', fontSize: 13, fontWeight: '600' },
  nutritionUnit: { color: '#64748B', fontWeight: '600' },
  nutritionGrid: { marginTop: 16, flexDirection: 'row', justifyContent: 'space-between' },
  nutritionItem: { flex: 1, alignItems: 'center', borderRightWidth: 1, borderRightColor: '#E2E8F0' },
  nutritionValue: { color: '#0F172A', fontSize: 13, fontWeight: '600' },
  nutritionLabel: { marginTop: 4, color: '#64748B', fontSize: 9, fontWeight: '600' },
  nutritionLink: { marginTop: 16, color: '#0F766E', fontSize: 11, fontWeight: '600' },
  nutritionText: { marginTop: 6, color: '#64748B', fontSize: 12, lineHeight: 18 },
  subscriptionCard: { marginTop: 16, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 20, padding: 16, backgroundColor: '#E8F8F1', borderWidth: 1, borderColor: '#A9DBC6' },
  ...
  subscriptionEyebrow: { color: '#0F766E', fontSize: 9, fontWeight: '600', letterSpacing: 1 },
  subscriptionTitle: { color: '#143D32', fontSize: 15, fontWeight: '600', marginTop: 2 },
  subscriptionText: { color: '#60766D', fontSize: 10, lineHeight: 15, marginTop: 4 },
  ...
  quantityLabel: { marginBottom: 4, color: '#64748B', fontSize: 10, fontWeight: '600' },
  ...
  quantityValue: { minWidth: 18, color: '#0F172A', fontSize: 15, fontWeight: '600', textAlign: 'center' },
  ...
  addButtonText: { color: '#0F766E', fontSize: 13, fontWeight: '600' },
  ...
  viewAll: { color: '#0F766E', fontSize: 12, fontWeight: '600' },
  relatedList: { gap: 12, paddingHorizontal: 18, paddingTop: 12 },
  relatedCard: { position: 'relative', width: 145, minHeight: 190, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', padding: 12, backgroundColor: '#FFFFFF' },
  relatedImage: { width: '100%', height: 92 },
  relatedName: { marginTop: 4, color: '#0F172A', fontSize: 12, lineHeight: 16, fontWeight: '600' },
  relatedPrice: { marginTop: 6, color: '#0F172A', fontSize: 14, fontWeight: '600' },
  ...
  relatedUnavailable: { color: '#FFFFFF', fontSize: 9, fontWeight: '600' },
  relatedCartText: { marginTop: 4, color: '#0F766E', fontSize: 10, fontWeight: '600' },
  floatingCart: { position: 'absolute', left: 18, right: 18, bottom: 92, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 16, padding: 12, backgroundColor: '#0F766E', elevation: 5, shadowColor: '#0F766E', shadowOpacity: 0.22, shadowRadius: 12, shadowOffset: { width: 0, height: 5 } },
  floatingIcon: { width: 38, height: 38, alignItems: 'center', justifyContent: 'center', borderRadius: 13, backgroundColor: '#CCFBF1' },
  floatingCopy: { flex: 1 },
  floatingTitle: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' },
  floatingTotal: { marginTop: 2, color: '#CCFBF1', fontSize: 12, fontWeight: '600' },
  floatingAction: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' },
});
