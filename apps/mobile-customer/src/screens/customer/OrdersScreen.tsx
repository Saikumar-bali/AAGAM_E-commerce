          ...
          <View>
            <View style={styles.brandHeader}>
              ...
              <Text style={styles.screenSubtitle}>
                Track current deliveries and review past orders.
              </Text>
            </View>
            {isError ? (
              <View style={styles.errorBanner}>
                <View style={styles.errorCopy}>
                  ...
                  <Text style={styles.errorText}>
                    Showing your last loaded order history.
                  </Text>
                </View>
...
const styles = StyleSheet.create({
  ...
  statusText: { color: "#0F766E", fontWeight: '600', fontSize: 12 },
  orderMeta: { marginTop: 6, color: "#64748B" },
  scheduleText: { marginTop: 8, color: "#047857", fontWeight: '600' },
  orderFooter: {
    marginTop: 16,
    flexDirection: "row",
    justifyContent: "space-between",
  ...
  amountLabel: { color: "#64748B", fontSize: 10, fontWeight: '600', marginBottom: 2 },
  totalText: { fontSize: 20, fontWeight: '600', color: "#0F172A" },
  chevron: { color: "#0F766E", fontWeight: '600', paddingBottom: 2 },
