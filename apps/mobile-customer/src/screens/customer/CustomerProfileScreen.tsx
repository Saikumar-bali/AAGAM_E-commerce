  ...
  const requestLocationPermission = async () => {
    ...
    const result = await PermissionsAndroid.request(
      PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
      {
        ...
        message: 'Aagaam uses your location to set delivery addresses.',
...
const styles = StyleSheet.create({
  ...
  topHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }, headerActions: { flexDirection: 'row', alignItems: 'center', gap: 8 }, topIcon: { width: 46, height: 46, borderRadius: 16, borderWidth: 1, borderColor: '#DDE7EA', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, topCart: { width: 48, height: 48, borderRadius: 16, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' }, profileHeading: { color: '#0F172A', fontSize: 28, fontWeight: '600', letterSpacing: -0.7 }, profileSubtitle: { marginTop: 4, marginBottom: 16, color: '#64748B', fontSize: 14, fontWeight: '600' },
  heroCard: { position: 'relative', flexDirection: 'row', gap: 16, alignItems: 'center', borderRadius: 24, backgroundColor: '#0F766E', padding: 20 }, headerLogout: { position: 'absolute', right: 14, top: 14, width: 38, height: 38, borderRadius: 20, alignItems: 'center', justifyContent: 'center', backgroundColor: '#CCFBF1', zIndex: 2 }, headerLogoutText: { color: '#115E59', fontSize: 22, fontWeight: '600' },
  avatar: { width: 64, height: 64, borderRadius: 20, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#FFFFFF' }, avatarImage: { width: 64, height: 64, borderRadius: 20, backgroundColor: '#CCFBF1', borderWidth: 2, borderColor: '#FFFFFF' }, avatarText: { color: '#115E59', fontSize: 26, fontWeight: '600' }, profileCopy: { flex: 1, paddingRight: 42 }, name: { fontSize: 24, fontWeight: '600', color: '#FFFFFF' }, email: { marginTop: 6, color: '#CCFBF1', fontWeight: '500' }, accountBadge: { alignSelf: 'flex-start', marginTop: 8, borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.16)', paddingHorizontal: 12, paddingVertical: 4 }, accountBadgeText: { color: '#FFFFFF', fontSize: 10, fontWeight: '600' },
  statsRow: { flexDirection: 'row', gap: 8, marginTop: 16 }, statCard: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FFFFFF', borderRadius: 16, padding: 12, borderWidth: 1, borderColor: '#E2E8F0' }, statIcon: { width: 38, height: 38, borderRadius: 20, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, statValue: { fontSize: 21, fontWeight: '600', color: '#0F172A' }, statLabel: { marginTop: 2, color: '#64748B', fontSize: 11, fontWeight: '600' },
  menuCard: { marginTop: 16, backgroundColor: '#FFFFFF', borderRadius: 20, borderWidth: 1, borderColor: '#E2E8F0', overflow: 'hidden' }, menuRow: { flexDirection: 'row', alignItems: 'center', padding: 16, gap: 12, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' }, menuIcon: { width: 40, height: 40, borderRadius: 15, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, menuTitle: { color: '#0F172A', fontWeight: '600', fontSize: 15 }, menuSubtitle: { marginTop: 4, color: '#64748B', fontWeight: '500', fontSize: 12 },
  sectionHeader: { marginTop: 22, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, sectionTitle: { fontSize: 20, fontWeight: '600', color: '#0F172A' }, linkButton: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 999, backgroundColor: '#CCFBF1' }, linkButtonText: { color: '#115E59', fontWeight: '600' },
  emptyCard: { marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 20, borderWidth: 1.5, borderStyle: 'dashed', borderColor: '#99F6E4', backgroundColor: '#FFFFFF', padding: 16 }, emptyAddressIcon: { width: 62, height: 62, borderRadius: 20, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, emptyAddressCopy: { flex: 1 }, emptyTitle: { color: '#0F172A', fontWeight: '600' }, emptyText: { marginTop: 4, color: '#64748B', lineHeight: 18 },
  addressCard: { marginTop: 12, backgroundColor: '#FFFFFF', borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', padding: 16 }, addressTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 12 }, addressLabelRow: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8 }, addressLabel: { fontSize: 12, fontWeight: '600', color: '#0F766E', textTransform: 'uppercase' }, smallAction: { color: '#0F766E', fontWeight: '600', fontSize: 12 }, addressName: { marginTop: 8, fontSize: 16, fontWeight: '600', color: '#0F172A' }, addressText: { marginTop: 4, color: '#475569' }, locationBadge: { marginTop: 8, alignSelf: 'flex-start', borderRadius: 999, backgroundColor: '#F0FDFA', color: '#0F766E', paddingHorizontal: 8, paddingVertical: 4, fontSize: 10, fontWeight: '600' }, deleteText: { color: '#DC2626', fontWeight: '600', fontSize: 12 }, addressActions: { marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 12, borderTopWidth: 1, borderTopColor: '#F1F5F9', paddingTop: 10 }, addressAction: { flexDirection: 'row', alignItems: 'center', gap: 4 }, deliverHere: { flex: 1, alignItems: 'center', borderRadius: 999, backgroundColor: '#0F766E', paddingVertical: 8 }, deliverHereText: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' }, viewAddresses: { marginTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 }, viewAddressesText: { color: '#0F766E', fontWeight: '600', fontSize: 12 },
  formCard: { marginTop: 16, backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#E2E8F0' }, formTitle: { fontSize: 18, fontWeight: '600', color: '#0F172A', marginBottom: 12 },
  inputText: { color: '#0F172A', fontSize: 14 }, inputPlaceholder: { color: '#94A3B8', fontSize: 14 },
  dialogOverlay: { flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(9,31,24,0.45)' }, dialogDismiss: { flex: 1 }, dialogSheet: { maxHeight: '88%', backgroundColor: '#FFFFFF', borderTopLeftRadius: 24, borderTopRightRadius: 24 }, dialogHandle: { alignSelf: 'center', width: 36, height: 4, borderRadius: 2, backgroundColor: '#D1D5DB', marginTop: 12, marginBottom: 4 }, dialogHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' }, dialogTitle: { fontSize: 18, fontWeight: '600', color: '#0F172A' }, dialogClose: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#F1F5F9', alignItems: 'center', justifyContent: 'center' }, dialogCloseText: { fontSize: 16, fontWeight: '600', color: '#64748B' }, dialogContent: { padding: 16, paddingBottom: 30 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' }, modalContent: { backgroundColor: '#FFFFFF', borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '70%', paddingBottom: 30 }, modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderBottomColor: '#E2E8F0' }, modalTitle: { fontSize: 17, fontWeight: '600', color: '#0F172A' }, modalClose: { width: 32, height: 32, borderRadius: 16, backgroundColor: '#F1F5F9', alignItems: 'center', justifyContent: 'center' }, modalCloseText: { fontSize: 16, fontWeight: '600', color: '#64748B' },
  localityItem: { paddingVertical: 16, paddingHorizontal: 16, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' }, localityName: { fontSize: 15, fontWeight: '600', color: '#0F172A' }, localityDetail: { fontSize: 12, fontWeight: '600', color: '#64748B', marginTop: 4 }, localityEmpty: { padding: 24, textAlign: 'center', color: '#64748B', fontSize: 13 }, locationPanel: { borderRadius: 16, backgroundColor: '#F0FDFA', borderWidth: 1, borderColor: '#CCFBF1', padding: 12, marginBottom: 12 }, locationPanelError: { borderColor: '#FCA5A5', backgroundColor: '#FEF2F2' }, locationChoiceRow: { flexDirection: 'row', gap: 8, marginBottom: 12 }, locationChoice: { flex: 1, alignItems: 'center', borderRadius: 12, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#99F6E4', paddingVertical: 12 }, locationChoiceActive: { backgroundColor: '#0F766E', borderColor: '#0F766E' }, locationChoiceText: { color: '#0F766E', fontSize: 11, fontWeight: '600' }, locationChoiceTextActive: { color: '#FFFFFF' }, locationModeTitle: { color: '#0F172A', fontSize: 13, fontWeight: '600', marginBottom: 4 }, locationModeText: { color: '#475569', fontSize: 11, lineHeight: 16, marginBottom: 12 }, locationHelp: { marginTop: 8, color: '#115E59', fontWeight: '500', fontSize: 12, textAlign: 'center' }, locationHelpError: { color: '#B91C1C' },
  inputGroup: { marginBottom: 12 }, inputLabel: { marginBottom: 4, color: '#475569', fontSize: 12, fontWeight: '600' }, inputLabelError: { color: '#B91C1C' }, input: { borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', borderRadius: 14, paddingHorizontal: 16, paddingVertical: 12, color: '#0F172A' }, inputError: { borderColor: '#EF4444', backgroundColor: '#FEF2F2' }, inputErrorText: { marginTop: 4, color: '#B91C1C', fontSize: 11, lineHeight: 16, fontWeight: '600' }, switchRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 4, marginBottom: 12 }, switchText: { color: '#0F172A', fontWeight: '500' }, saveButton: { backgroundColor: '#0F766E', borderRadius: 16, paddingVertical: 16, alignItems: 'center' }, saveButtonText: { color: '#FFFFFF', fontWeight: '600' },
  stepButtons: { flexDirection: 'row', gap: 12, marginTop: 8 }, stepBackButton: { flex: 1, alignItems: 'center', borderRadius: 16, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0', paddingVertical: 16 }, stepBackButtonText: { color: '#475569', fontWeight: '600' }, stepNextButton: { flex: 2, alignItems: 'center', borderRadius: 14, backgroundColor: '#0F766E', paddingVertical: 16 }, stepNextButtonDisabled: { backgroundColor: '#94A3B8' }, stepNextButtonText: { color: '#FFFFFF', fontWeight: '600' }, locationSummary: { flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 12, backgroundColor: '#E6FFFA', padding: 12 }, locationSummaryText: { flex: 1, fontSize: 12, fontWeight: '500', color: '#134E4A' }, changeLocationText: { fontSize: 12, fontWeight: '600', color: '#0F766E' },
  fullScreenMapContainer: { flex: 1, backgroundColor: '#F8FAFC' }, fullScreenMapHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingTop: 50, paddingBottom: 12, backgroundColor: 'rgba(255,255,255,0.95)', zIndex: 10 }, fullScreenCloseBtn: { width: 36, height: 36, borderRadius: 16, backgroundColor: '#F1F5F9', alignItems: 'center', justifyContent: 'center' }, fullScreenCloseText: { fontSize: 18, fontWeight: '600', color: '#475569' }, fullScreenTitle: { fontSize: 17, fontWeight: '600', color: '#0F172A' }, fullScreenMapWrap: { flex: 1, position: 'relative' }, centerPinOverlay: { position: 'absolute', top: '50%', left: '50%', marginLeft: -14, marginTop: -28, alignItems: 'center', zIndex: 5 }, centerPinDot: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#0F766E', borderWidth: 3, borderColor: '#FFFFFF', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.25, shadowRadius: 4, elevation: 5 }, centerPinShadow: { width: 12, height: 4, borderRadius: 2, backgroundColor: 'rgba(0,0,0,0.15)', marginTop: 2 }, fullScreenBottomBar: { flexDirection: 'row', alignItems: 'center', gap: 12, padding: 16, paddingBottom: 30, backgroundColor: '#FFFFFF', borderTopWidth: 1, borderTopColor: '#E2E8F0' }, fullScreenConfirmBtn: { flex: 1, alignItems: 'center', borderRadius: 14, backgroundColor: '#0F766E', paddingVertical: 16 }, fullScreenConfirmBtnDisabled: { backgroundColor: '#94A3B8' }, fullScreenConfirmText: { color: '#FFFFFF', fontWeight: '600', fontSize: 15 },
});
