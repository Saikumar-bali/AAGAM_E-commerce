...
const styles = StyleSheet.create({
  ...
  topHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }, headerActions: { flexDirection: 'row', alignItems: 'center', gap: 8 }, topIcon: { width: 46, height: 46, borderRadius: 16, borderWidth: 1, borderColor: '#DDE7EA', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, topCart: { width: 48, height: 48, borderRadius: 17, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' }, profileHeading: { color: '#0F172A', fontSize: 28, fontWeight: '600', letterSpacing: -0.7 }, profileSubtitle: { marginTop: 4, marginBottom: 16, color: '#64748B', fontSize: 14, fontWeight: '600' },
  ...
  avatar: { width: 64, height: 64, borderRadius: 22, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#FFFFFF' }, avatarImage: { width: 64, height: 64, borderRadius: 22, backgroundColor: '#CCFBF1', borderWidth: 2, borderColor: '#FFFFFF' }, avatarText: { color: '#115E59', fontSize: 26, fontWeight: '600' }, profileCopy: { flex: 1, paddingRight: 42 }, name: { fontSize: 24, fontWeight: '600', color: '#FFFFFF' }, email: { marginTop: 6, color: '#CCFBF1', fontWeight: '500' }, accountBadge: { alignSelf: 'flex-start', marginTop: 8, borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.16)', paddingHorizontal: 10, paddingVertical: 4 }, accountBadgeText: { color: '#FFFFFF', fontSize: 10, fontWeight: '600' },
  statsRow: { flexDirection: 'row', gap: 8, marginTop: 14 }, statCard: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8, backgroundColor: '#FFFFFF', borderRadius: 18, padding: 10, borderWidth: 1, borderColor: '#E2E8F0' }, statIcon: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, statValue: { fontSize: 21, fontWeight: '600', color: '#0F172A' }, statLabel: { marginTop: 2, color: '#64748B', fontSize: 11, fontWeight: '600' },
  menuCard: { marginTop: 16, backgroundColor: '#FFFFFF', borderRadius: 22, borderWidth: 1, borderColor: '#E2E8F0', overflow: 'hidden' }, menuRow: { flexDirection: 'row', alignItems: 'center', padding: 14, gap: 12, borderBottomWidth: 1, borderBottomColor: '#F1F5F9' }, menuIcon: { width: 40, height: 40, borderRadius: 15, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, menuTitle: { color: '#0F172A', fontWeight: '600', fontSize: 15 }, menuSubtitle: { marginTop: 4, color: '#64748B', fontWeight: '500', fontSize: 12 },
  sectionHeader: { marginTop: 22, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }, sectionTitle: { fontSize: 20, fontWeight: '600', color: '#0F172A' }, linkButton: { flexDirection: 'row', alignItems: 'center', gap: 4, paddingHorizontal: 14, paddingVertical: 8, borderRadius: 999, backgroundColor: '#CCFBF1' }, linkButtonText: { color: '#115E59', fontWeight: '600' },
  emptyCard: { marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 20, borderWidth: 1.5, borderStyle: 'dashed', borderColor: '#99F6E4', backgroundColor: '#FFFFFF', padding: 14 }, emptyAddressIcon: { width: 62, height: 62, borderRadius: 22, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, emptyAddressCopy: { flex: 1 }, emptyTitle: { color: '#0F172A', fontWeight: '600' }, emptyText: { marginTop: 4, color: '#64748B', lineHeight: 18 },
  addressCard: { marginTop: 12, backgroundColor: '#FFFFFF', borderRadius: 18, borderWidth: 1, borderColor: '#E2E8F0', padding: 14 }, addressTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', gap: 10 }, addressLabelRow: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8 }, addressLabel: { fontSize: 12, fontWeight: '600', color: '#0F766E', textTransform: 'uppercase' }, smallAction: { color: '#0F766E', fontWeight: '600', fontSize: 12 }, addressName: { marginTop: 8, fontSize: 16, fontWeight: '600', color: '#0F172A' }, addressText: { marginTop: 4, color: '#475569' }, locationBadge: { marginTop: 8, alignSelf: 'flex-start', borderRadius: 999, backgroundColor: '#F0FDFA', color: '#0F766E', paddingHorizontal: 8, paddingVertical: 4, fontSize: 10, fontWeight: '600' }, deleteText: { color: '#DC2626', fontWeight: '600', fontSize: 12 }, addressActions: { marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 12, borderTopWidth: 1, borderTopColor: '#F1F5F9', paddingTop: 10 }, addressAction: { flexDirection: 'row', alignItems: 'center', gap: 4 }, deliverHere: { flex: 1, alignItems: 'center', borderRadius: 999, backgroundColor: '#0F766E', paddingVertical: 8 }, deliverHereText: { color: '#FFFFFF', fontSize: 12, fontWeight: '600' }, viewAddresses: { marginTop: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 4 }, viewAddressesText: { color: '#0F766E', fontWeight: '600', fontSize: 12 },
  formCard: { marginTop: 16, backgroundColor: '#FFFFFF', borderRadius: 18, padding: 16, borderWidth: 1, borderColor: '#E2E8F0' }, formTitle: { fontSize: 18, fontWeight: '600', color: '#0F172A', marginBottom: 12 },
