...
const styles = StyleSheet.create({
  ...
  catalogHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 15, gap: 12 }, backButton: { width: 48, height: 48, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, catalogTitle: { flex: 1, color: '#0F172A', fontSize: 25, fontWeight: '600' },
  subscriptionHero: { minHeight: 102, borderRadius: 22, padding: 16, backgroundColor: '#0F766E', flexDirection: 'row', alignItems: 'center', gap: 12, marginBottom: 4 },
