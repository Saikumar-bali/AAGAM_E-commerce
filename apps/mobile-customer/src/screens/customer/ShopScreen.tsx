...
const styles = StyleSheet.create({
  ...
  brandRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16, gap: 12 },
  headerLocation: { flex: 1, justifyContent: 'center', paddingVertical: 2 },
  headerGreeting: { color: '#0F172A', fontSize: 11, fontWeight: '500' },
  headerLocationBottom: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 2 },
  headerLocationText: { flex: 1, color: '#475569', fontSize: 12, fontWeight: '500' },
  headerLocationStrong: { color: '#0F766E', fontWeight: '600' },
  ...
  cartButton: { position: 'relative', width: 48, height: 48, borderRadius: 16, backgroundColor: '#CCFBF1', alignItems: 'center', justifyContent: 'center' },
  ...
  subscriptionHeroTitle: { color: '#FFFFFF', fontSize: 15, fontWeight: '600', marginTop: 4 },
  subscriptionHeroText: { color: '#D8F5EA', fontSize: 10, lineHeight: 15, marginTop: 4 },
  offerBlock: { marginTop: 18 }, headingRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }, headingCopy: { flexDirection: 'row', alignItems: 'center', gap: 8 }, smallHeading: { color: '#0F172A', fontWeight: '600', textTransform: 'uppercase' }, linkRow: { flexDirection: 'row', alignItems: 'center', gap: 4 }, link: { color: '#0F766E', fontWeight: '600', fontSize: 12 }, searchWrap: { marginTop: 16, flexDirection: 'row', alignItems: 'center', gap: 8, minHeight: 54, paddingHorizontal: 16, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF' }, search: { flex: 1, color: '#0F172A', fontSize: 14, fontWeight: '600', paddingVertical: 0 }, categoryRail: { paddingVertical: 16, gap: 12 }, categoryTile: { width: 83, alignItems: 'center', gap: 6 }, categoryTileActive: { transform: [{ scale: 1.02 }] }, categoryImageWrap: { width: 66, height: 66, borderRadius: 20, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, categoryImageWrapActive: { borderColor: '#0F766E', backgroundColor: '#0F766E' }, categoryImage: { width: 54, height: 54 }, categoryText: { color: '#334155', fontSize: 11, lineHeight: 14, fontWeight: '600', textAlign: 'center' }, categoryTextActive: { color: '#0F766E' }, catalogTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }, title: { color: '#0F172A', fontSize: 21, fontWeight: '600' }, catalogSubtitle: { marginTop: 4, color: '#64748B', fontSize: 12, fontWeight: '500' }, inlineError: { marginTop: 4, color: '#B45309', fontSize: 11, fontWeight: '600' }, sortButton: { flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 999, backgroundColor: '#E6FFFA', paddingHorizontal: 12, paddingVertical: 8 }, sortText: { color: '#0F766E', fontSize: 12, fontWeight: '600' },
  section: { marginBottom: 24 }, sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }, sectionTitle: { color: '#0F172A', fontSize: 18, fontWeight: '600' }, sectionSubtitle: { marginTop: 4, color: '#64748B', fontSize: 12, fontWeight: '600' }, viewAll: { flexDirection: 'row', alignItems: 'center', gap: 4, borderRadius: 999, backgroundColor: '#E6FFFA', paddingHorizontal: 12, paddingVertical: 8 }, columns: { gap: 12 }, card: { flex: 1, marginBottom: 16, borderRadius: 20, overflow: 'hidden', backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#E2E8F0' }, cardCompact: { flex: 0, width: 168, marginRight: 12 }, disabled: { opacity: 0.62 }, imageWrap: { position: 'relative', height: 132, backgroundColor: '#FFFFFF' }, productImage: { width: '100%', height: '100%' }, discount: { position: 'absolute', left: 8, top: 8, overflow: 'hidden', borderRadius: 9, backgroundColor: '#0F766E', color: '#FFFFFF', paddingHorizontal: 8, paddingVertical: 4, fontSize: 10, fontWeight: '600' }, inCart: { position: 'absolute', right: 8, top: 8, borderRadius: 999, backgroundColor: '#E6FFFA', paddingHorizontal: 8, paddingVertical: 4 }, inCartText: { color: '#0F766E', fontSize: 9, fontWeight: '600' }, cardBody: { padding: 12 }, productName: { minHeight: 38, color: '#0F172A', fontSize: 14, lineHeight: 19, fontWeight: '600' }, measure: { marginTop: 4, color: '#64748B', fontSize: 11, fontWeight: '500' }, ratingPill: { alignSelf: 'flex-start', marginTop: 8, borderRadius: 7, backgroundColor: '#E6FFFA', paddingHorizontal: 8, paddingVertical: 4 }, ratingText: { color: '#115E59', fontSize: 10, fontWeight: '600' }, cardFooter: { marginTop: 12, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between', gap: 6 }, priceRow: { flexDirection: 'row', alignItems: 'center', gap: 8 }, price: { color: '#0F172A', fontSize: 16, fontWeight: '600' }, mrp: { color: '#94A3B8', fontSize: 11, textDecorationLine: 'line-through', fontWeight: '500' }, stock: { marginTop: 4, color: '#0F766E', fontSize: 10, fontWeight: '600' }, out: { marginTop: 4, color: '#DC2626', fontSize: 10, fontWeight: '600' }, add: { width: 39, height: 39, borderRadius: 20, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center' }, addDisabled: { backgroundColor: '#94A3B8' }, retry: { marginTop: 12, borderRadius: 999, backgroundColor: '#0F766E', paddingHorizontal: 16, paddingVertical: 12 }, retryText: { color: '#FFFFFF', fontWeight: '600' }, error: { color: '#B91C1C', fontWeight: '600' }, empty: { alignItems: 'center', paddingVertical: 50 },
  homeSectionHeading: { marginTop: 20, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  collectionRail: { gap: 12, paddingTop: 13, paddingBottom: 22 },
  collectionCard: { width: 118, minHeight: 132, borderRadius: 20, alignItems: 'center', justifyContent: 'space-between', padding: 12 },
  collectionImage: { width: 88, height: 88 },
  collectionText: { color: '#0F172A', fontSize: 12, lineHeight: 15, fontWeight: '600', textAlign: 'center' },
  ...
  trustText: { color: '#0F172A', fontSize: 8, lineHeight: 11, fontWeight: '600', textAlign: 'center' },
});
