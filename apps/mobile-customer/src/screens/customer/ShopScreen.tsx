...
const styles = StyleSheet.create({
  ...
  subscriptionHeroEyebrow: { color: '#BFEADA', fontSize: 9, fontWeight: '900', letterSpacing: 1 },
  subscriptionHeroTitle: { color: '#FFFFFF', fontSize: 15, fontWeight: '900', marginTop: 3 },
  subscriptionHeroText: { color: '#D8F5EA', fontSize: 10, lineHeight: 15, marginTop: 3 },
