...
const styles = StyleSheet.create({
  screen: { flex: 1, backgroundColor: '#F8FAFC' }, searchContent: { paddingHorizontal: 16, backgroundColor: '#F8FAFC' }, content: { paddingHorizontal: 16, paddingBottom: 170 }, header: { paddingTop: 18, paddingBottom: 8 }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24 },
