...
const styles = StyleSheet.create({ screen: { flex: 1, backgroundColor: '#F5F8F6' }, flex: { flex: 1 }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 12 }, error: { color: '#9F2F2F', fontWeight: '600' }, link: { color: '#0F766E', fontWeight: '600' }, header: { backgroundColor: '#FFFFFF', paddingHorizontal: 18, paddingVertical: 14, flexDirection: 'row', alignItems: 'center', gap: 12, borderBottomWidth: 1, borderBottomColor: '#E5ECE8' }, iconButton: { width: 44, height: 44, borderRadius: 16, backgroundColor: '#EFF7F3', alignItems: 'center', justifyContent: 'center' }, eyebrow: { color: '#0F766E', fontWeight: '600', fontSize: 10, letterSpacing: 1.2 }, title: { color: '#163B31', fontSize: 23, fontWeight: '600' }, content: { padding: 16, paddingBottom: 118, gap: 14 }, planCard: { flexDirection: 'row', gap: 14, backgroundColor: '#0C7659', borderRadius: 24, padding: 17, alignItems: 'center' }, planImage: { width: 74, height: 74, borderRadius: 18, backgroundColor: '#FFFFFF' }, planName: { color: '#FFFFFF', fontSize: 19, fontWeight: '600' }, planMeta: { color: '#D5F3E7', fontSize: 12, marginTop: 4 }, planPrice: { color: '#FFFFFF', fontSize: 22, fontWeight: '600', marginTop: 8 }, section: { backgroundColor: '#FFFFFF', borderRadius: 22, padding: 16, borderWidth: 1, borderColor: '#E1EAE5' }, sectionHeader: { flexDirection: 'row', gap: 8, alignItems: 'center', marginBottom: 12 }, sectionTitle: { color: '#1A4034', fontSize: 16, fontWeight: '600' }, optionGrid: { gap: 8 }, optionCard: { borderWidth: 1, borderColor: '#DDE7E2', borderRadius: 16, padding: 12 }, optionCardSelected: { borderColor: '#0F766E', backgroundColor: '#F0FAF5' }, optionTop: { flexDirection: 'row', justifyContent: 'space-between' }, optionTitle: { fontWeight: '600', color: '#264A3E' }, optionText: { color: '#687A72', fontSize: 12, marginTop: 4 }, input: { minHeight: 50, borderWidth: 1, borderColor: '#D9E4DE', borderRadius: 15, paddingHorizontal: 14, color: '#1F3F35', backgroundColor: '#FBFDFC' }, multiline: { minHeight: 84, textAlignVertical: 'top', paddingTop: 13 }, help: { fontSize: 10, color: '#75857E', marginTop: 8 }, readOnly: { minHeight: 50, borderRadius: 15, backgroundColor: '#F2F7F4', justifyContent: 'center', paddingHorizontal: 14 }, readOnlyText: { color: '#274A3E', fontWeight: '600' }, methodList: { gap: 8 }, method: { flexDirection: 'row', gap: 12, padding: 12, borderRadius: 16, borderWidth: 1, borderColor: '#DDE7E2' }, methodSelected: { borderColor: '#0F766E', backgroundColor: '#F0FAF5' }, radio: { width: 22, height: 22, borderRadius: 11, borderWidth: 2, borderColor: '#AABBB3', alignItems: 'center', justifyContent: 'center' }, radioSelected: { borderColor: '#0F766E' }, radioDot: { width: 10, height: 10, borderRadius: 5, backgroundColor: '#0F766E' }, methodTitle: { color: '#23473B', fontWeight: '600' }, methodCopy: { color: '#718079', fontSize: 11, marginTop: 2 }, dropFields: { gap: 8, marginTop: 10 }, summary: { gap: 10 }, row: { flexDirection: 'row', justifyContent: 'space-between', gap: 12 }, rowLabel: { color: '#677A72', fontSize: 12 }, rowValue: { color: '#2E4A40', fontSize: 12, fontWeight: '600', textAlign: 'right' }, rowStrong: { color: '#B45C00', fontSize: 15 }, cashNotice: { marginTop: 14, borderRadius: 15, padding: 12, backgroundColor: '#FFF3DF', color: '#854800', fontSize: 12, fontWeight: '600', lineHeight: 18 }, footer: { position: 'absolute', left: 0, right: 0, bottom: 0, padding: 16, backgroundColor: '#FFFFFF', borderTopWidth: 1, borderTopColor: '#E3EAE6' }, submit: { minHeight: 54, borderRadius: 18, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center' }, disabled: { opacity: 0.45 }, submitText: { color: '#FFFFFF', fontWeight: '600', fontSize: 16 },
  slotRow: { flexDirection: 'row', gap: 8 },
  slotButton: { flex: 1, paddingVertical: 10, paddingHorizontal: 8, borderRadius: 10, borderWidth: 1, borderColor: '#E5E7EB', alignItems: 'center', backgroundColor: '#FFFFFF' },
  slotButtonAM: { borderColor: '#F59E0B', backgroundColor: '#FFFBEB' },
  slotButtonPM: { borderColor: '#6366F1', backgroundColor: '#EEF2FF' },
  slotText: { fontSize: 14, fontWeight: '600', color: '#374151' },
  slotTextSelected: { color: '#0F766E', fontWeight: '600' },
  slotTime: { fontSize: 11, color: '#6B7280', marginTop: 2 } });
