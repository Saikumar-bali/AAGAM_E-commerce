...
import { ArrowLeft, ArrowRight, MapPin, Minus, Plus, Tag, Trash2 } from 'lucide-react-native';
...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#F8FAFC' }, list: { padding: 16, paddingBottom: 160 }, header: { flexDirection: 'row', alignItems: 'center', marginBottom: 16, gap: 12 }, backButton: { width: 50, height: 50, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }, headerCopy: { flex: 1 }, title: { color: '#0F172A', fontSize: 24, fontWeight: '600' }, subtitle: { marginTop: 4, color: '#0F766E', fontSize: 13, fontWeight: '600' }, cartItem: { flexDirection: 'row', alignItems: 'center', minHeight: 130, marginBottom: 12, padding: 12, borderRadius: 20, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', gap: 12 }, itemImage: { width: 88, height: 88, borderRadius: 15, backgroundColor: '#FFFFFF' }, itemDetails: { flex: 1, alignSelf: 'stretch', justifyContent: 'center' }, itemName: { color: '#0F172A', fontSize: 15, lineHeight: 20, fontWeight: '600' }, measure: { marginTop: 4, color: '#64748B', fontSize: 12, fontWeight: '600' }, itemPriceRow: { marginTop: 8, flexDirection: 'row', alignItems: 'baseline', flexWrap: 'wrap', gap: 6 }, itemPrice: { color: '#0F172A', fontSize: 16, fontWeight: '600' }, itemMrp: { color: '#94A3B8', fontSize: 11, fontWeight: '600', textDecorationLine: 'line-through' }, itemSaving: { marginTop: 2, color: '#B45309', fontSize: 11, fontWeight: '600' }, stock: { marginTop: 2, color: '#0F766E', fontSize: 11, fontWeight: '600' }, stockPending: { marginTop: 2, color: '#B45309', fontSize: 11, fontWeight: '600' }, itemActions: { alignItems: 'flex-end', justifyContent: 'space-between', alignSelf: 'stretch', paddingVertical: 2 }, quantityContainer: { flexDirection: 'row', alignItems: 'center', borderRadius: 12, borderWidth: 1, borderColor: '#E2E8F0', padding: 3, gap: 4 }, qtyButton: { width: 28, height: 28, borderRadius: 9, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, quantity: { minWidth: 20, textAlign: 'center', color: '#0F172A', fontWeight: '600' }, lineTotal: { color: '#0F172A', fontSize: 15, fontWeight: '600' }, couponCard: { marginTop: 4, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 16, borderWidth: 1, borderColor: '#99F6E4', backgroundColor: '#F0FDFA', padding: 12 }, couponIcon: { width: 41, height: 41, borderRadius: 14, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center' }, couponCopy: { flex: 1 }, couponTitle: { color: '#0F172A', fontWeight: '600' }, couponText: { marginTop: 2, color: '#64748B', fontSize: 12, fontWeight: '600' }, applyText: { color: '#0F766E', fontWeight: '600' }, infoCard: { marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 16, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', padding: 12 }, infoIcon: { width: 41, height: 41, borderRadius: 20, backgroundColor: '#0F766E', alignItems: 'center', justifyContent: 'center' }, infoCopy: { flex: 1 }, infoLabel: { color: '#64748B', fontSize: 11, fontWeight: '500' }, infoTitle: { marginTop: 4, color: '#0F172A', fontSize: 14, fontWeight: '600' }, infoText: { marginTop: 2, color: '#64748B', fontSize: 11, fontWeight: '600' }, changeText: { color: '#0F766E', fontWeight: '600', borderWidth: 1, borderColor: '#0F766E', borderRadius: 10, paddingHorizontal: 8, paddingVertical: 8 }, summaryCard: { marginTop: 12, borderRadius: 20, borderWidth: 1, borderColor: '#E2E8F0', backgroundColor: '#FFFFFF', padding: 16 }, summaryRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 12 }, summaryLabel: { color: '#475569', fontWeight: '500' }, summaryValue: { color: '#0F172A', fontWeight: '600' }, savingsLabel: { color: '#0F766E', fontWeight: '600' }, savingsValue: { color: '#0F766E', fontWeight: '600' }, divider: { height: 1, marginVertical: 3, backgroundColor: '#E2E8F0' }, totalRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingTop: 10 }, totalLabel: { color: '#0F172A', fontSize: 16, fontWeight: '600' }, taxText: { marginTop: 2, color: '#64748B', fontSize: 11, fontWeight: '600' }, totalValue: { color: '#0F172A', fontSize: 24, fontWeight: '600' }, savedStrip: { marginHorizontal: -16, marginBottom: -16, marginTop: 16, alignItems: 'center', borderBottomLeftRadius: 20, borderBottomRightRadius: 20, backgroundColor: '#E6FFFA', paddingVertical: 12 }, savedStripText: { color: '#0F766E', fontSize: 12, fontWeight: '600' }, checkoutButton: { marginTop: 16, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, borderRadius: 16, backgroundColor: '#0F766E', paddingVertical: 16 }, checkoutText: { color: '#FFFFFF', fontSize: 16, fontWeight: '600' }, emptyScreen: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 24, backgroundColor: '#F8FAFC' }, emptyIcon: { width: 76, height: 76, borderRadius: 24, backgroundColor: '#E6FFFA', alignItems: 'center', justifyContent: 'center' }, emptyTitle: { marginTop: 18, color: '#0F172A', fontSize: 22, fontWeight: '600' }, emptyText: { marginTop: 8, color: '#64748B', textAlign: 'center', lineHeight: 20 }, primaryButton: { marginTop: 20, flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 16, backgroundColor: '#0F766E', paddingHorizontal: 18, paddingVertical: 12 }, primaryButtonText: { color: '#FFFFFF', fontWeight: '600' },
